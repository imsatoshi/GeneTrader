...
class GeneTrader_gen30_1727304467_5789(IStrategy):
    minimal_roi = {
        "0": 1
    }
    timeframe = '5m'
    ...
    buy_rsi_32 = IntParameter(15.0, 50.0, default=34, space='buy', optimize=True)
    buy_sma15_32 = DecimalParameter(0.9, 1.0, default=0.974, space='buy', optimize=True)
    buy_cti_32 = DecimalParameter(-1.0, 1.0, default=-0.91, space='buy', optimize=True)

    sell_fastx = IntParameter(50.0, 100.0, default=51, space='sell', optimize=True)
