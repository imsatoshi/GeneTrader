...
class GeneTrader_gen29_1733278904_5768(IStrategy):
    minimal_roi = {
        "0": 1
    }
    timeframe = '5m'
    ...
    buy_rsi_fast_32 = IntParameter(20.0, 70.0, default=51, space='buy', optimize=True)
    ...
    buy_cti_32 = DecimalParameter(-1.0, 1.0, default=0.55, space='buy', optimize=True)

    sell_fastx = IntParameter(50.0, 100.0, default=96, space='sell', optimize=True)

    sell_loss_cci = IntParameter(0.0, 600.0, default=480, space='sell', optimize=True)
    sell_loss_cci_profit = DecimalParameter(-0.15, 0.0, default=-0.14, space='sell', optimize=True)
