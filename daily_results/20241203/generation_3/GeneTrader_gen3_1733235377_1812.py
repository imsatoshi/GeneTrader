...
class GeneTrader_gen3_1733235377_1812(IStrategy):
    minimal_roi = {
        "0": 1
    }
    timeframe = '5m'
    ...
    buy_rsi_32 = IntParameter(15.0, 50.0, default=30, space='buy', optimize=True)
    buy_sma15_32 = DecimalParameter(0.9, 1.0, default=0.961, space='buy', optimize=True)
    buy_cti_32 = DecimalParameter(-1.0, 1.0, default=0.97, space='buy', optimize=True)

    sell_fastx = IntParameter(50.0, 100.0, default=77, space='sell', optimize=True)

    sell_loss_cci = IntParameter(0.0, 600.0, default=364, space='sell', optimize=True)
    sell_loss_cci_profit = DecimalParameter(-0.15, 0.0, default=-0.13, space='sell', optimize=True)
