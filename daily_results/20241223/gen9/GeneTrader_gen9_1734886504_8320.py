...
class GeneTrader_gen9_1734886504_8320(IStrategy):
    """
    ...
    buy_rmi = IntParameter(30.0, 50.0, default=44, space='buy', optimize=True)
    buy_cci = IntParameter(-135.0, -90.0, default=-99, space='buy', optimize=True)
    buy_srsi_fk = IntParameter(30.0, 50.0, default=31, space='buy', optimize=True)
    buy_cci_length = IntParameter(25.0, 45.0, default=45, space='buy', optimize=True)
    buy_rmi_length = IntParameter(8.0, 20.0, default=13, space='buy', optimize=True)

    buy_bb_width = DecimalParameter(0.065, 0.135, default=0.109, space='buy', optimize=True)
    buy_bb_delta = DecimalParameter(0.018, 0.035, default=0.021, space='buy', optimize=True)
    
    buy_roc_1h = IntParameter(-25.0, 200.0, default=25, space='buy', optimize=True)
    buy_bb_width_1h = DecimalParameter(0.3, 2.0, default=1.3, space='buy', optimize=True)

    #ClucHA
    is_optimize_clucha = False
    buy_clucha_bbdelta_close = DecimalParameter(0.0005, 0.02, default=0.013, space='buy', optimize=True)
    buy_clucha_bbdelta_tail = DecimalParameter(0.7, 1.0, default=0.7, space='buy', optimize=True)
    buy_clucha_close_bblower = DecimalParameter(0.0005, 0.02, default=0.012, space='buy', optimize=True)
    buy_clucha_closedelta_close = DecimalParameter(0.0005, 0.02, default=0.02, space='buy', optimize=True)
    buy_clucha_rocr_1h = DecimalParameter(0.5, 1.0, default=0.54, space='buy', optimize=True)
    
    #Local_Uptrend    
    buy_ema_diff = DecimalParameter(0.022, 0.027, default=0.024, space='buy', optimize=True)
    buy_bb_factor = DecimalParameter(0.99, 0.999, default=0.99, space='buy', optimize=True)
    buy_closedelta = DecimalParameter(12.0, 18.0, default=13.4, space='buy', optimize=True)
    
    # buy params
    rocr_1h = DecimalParameter(0.5, 1.0, default=0.54, space='buy', optimize=True)
    rocr1_1h = DecimalParameter(0.5, 1.0, default=0.5, space='buy', optimize=True)
    bbdelta_close = DecimalParameter(0.0005, 0.02, default=0.013, space='buy', optimize=True)
    closedelta_close = DecimalParameter(0.0005, 0.02, default=0.02, space='buy', optimize=True)
    bbdelta_tail = DecimalParameter(0.7, 1.0, default=0.7, space='buy', optimize=True)
    close_bblower = DecimalParameter(0.0005, 0.02, default=0.012, space='buy', optimize=True)

    # sell params
    sell_fisher = DecimalParameter(0.1, 0.5, default=0.308, space='sell', optimize=True)
    sell_bbmiddle_close = DecimalParameter(0.97, 1.1, default=0.97, space='sell', optimize=True)
    
    #Deadfish
    sell_deadfish_bb_width = DecimalParameter(0.03, 0.75, default=0.47, space='sell', optimize=True)
    sell_deadfish_profit = DecimalParameter(-0.15, -0.05, default=-0.05, space='sell', optimize=True)
    sell_deadfish_bb_factor = DecimalParameter(0.9, 1.2, default=1.06, space='sell', optimize=True)
    sell_deadfish_volume_factor = DecimalParameter(1.0, 2.5, default=2.0, space='sell', optimize=True)
    
    # SMAOffset
    base_nb_candles_buy = IntParameter(8.0, 20.0, default=11, space='buy', optimize=True)
    base_nb_candles_sell = IntParameter(8.0, 50.0, default=41, space='sell', optimize=True)
    low_offset = DecimalParameter(0.985, 0.995, default=0.995, space='buy', optimize=True)
    high_offset = DecimalParameter(1.005, 1.015, default=1.015, space='sell', optimize=True)
    high_offset_2 = DecimalParameter(1.01, 1.02, default=1.02, space='sell', optimize=True)
    ...
    sell_trail_profit_min_2 = DecimalParameter(0.04, 0.1, default=0.09, space='sell', optimize=True)
    ...
    pHSL = DecimalParameter(-0.5, -0.04, default=-0.211, space='sell', optimize=True)
    # profit threshold 1, trigger point, SL_1 is used
    pPF_1 = DecimalParameter(0.008, 0.02, default=0.02, space='sell', optimize=True)
    pSL_1 = DecimalParameter(0.008, 0.02, default=0.012, space='sell', optimize=True)

    # profit threshold 2, SL_2 is used
    pPF_2 = DecimalParameter(0.04, 0.1, default=0.053, space='sell', optimize=True)
    pSL_2 = DecimalParameter(0.02, 0.07, default=0.021, space='sell', optimize=True)
