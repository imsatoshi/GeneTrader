...
class GeneTrader_gen1_1733569236_3948(IStrategy):
    INTERFACE_VERSION = 2
    ...
    # Multi Offset
    base_nb_candles_buy = IntParameter(5.0, 80.0, default=30, space='buy', optimize=True)
    base_nb_candles_sell = IntParameter(5.0, 80.0, default=61, space='sell', optimize=True)
    low_offset_sma = DecimalParameter(0.9, 0.99, default=0.93, space='buy', optimize=True)
    high_offset_sma = DecimalParameter(0.99, 1.1, default=1.0, space='sell', optimize=True)
    low_offset_ema = DecimalParameter(0.9, 0.99, default=0.94, space='buy', optimize=True)
    high_offset_ema = DecimalParameter(0.99, 1.1, default=1.0, space='sell', optimize=True)
    low_offset_trima = DecimalParameter(0.9, 0.99, default=0.98, space='buy', optimize=True)
    high_offset_trima = DecimalParameter(0.99, 1.1, default=1.03, space='sell', optimize=True)
    low_offset_t3 = DecimalParameter(0.9, 0.99, default=0.99, space='buy', optimize=True)
    high_offset_t3 = DecimalParameter(0.99, 1.1, default=1.09, space='sell', optimize=True)
    low_offset_kama = DecimalParameter(0.9, 0.99, default=0.93, space='buy', optimize=True)
    high_offset_kama = DecimalParameter(0.99, 1.1, default=1.03, space='sell', optimize=True)

    # Protection
    ewo_low = DecimalParameter(-20.0, -8.0, default=-13.8, space='buy', optimize=True)
    ewo_high = DecimalParameter(2.0, 12.0, default=8.0, space='buy', optimize=True)
    fast_ewo = IntParameter(10.0, 50.0, default=10, space='buy', optimize=True)
    slow_ewo = IntParameter(100.0, 200.0, default=190, space='buy', optimize=True)
    ...
    buy_condition_2_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=True)
    ...
    # Normal dips
    buy_dip_threshold_1 = DecimalParameter(0.001, 0.05, default=0.006, space='buy', optimize=True)
    buy_dip_threshold_2 = DecimalParameter(0.01, 0.2, default=0.146, space='buy', optimize=True)
    buy_dip_threshold_3 = DecimalParameter(0.05, 0.4, default=0.186, space='buy', optimize=True)
    buy_dip_threshold_4 = DecimalParameter(0.2, 0.5, default=0.259, space='buy', optimize=True)
    # Strict dips
    buy_dip_threshold_5 = DecimalParameter(0.001, 0.05, default=0.038, space='buy', optimize=True)
    buy_dip_threshold_6 = DecimalParameter(0.01, 0.2, default=0.02, space='buy', optimize=True)
    buy_dip_threshold_7 = DecimalParameter(0.05, 0.4, default=0.113, space='buy', optimize=True)
    buy_dip_threshold_8 = DecimalParameter(0.2, 0.5, default=0.373, space='buy', optimize=True)
    # Loose dips
    buy_dip_threshold_9 = DecimalParameter(0.001, 0.05, default=0.012, space='buy', optimize=True)
    buy_dip_threshold_10 = DecimalParameter(0.01, 0.2, default=0.069, space='buy', optimize=True)
    buy_dip_threshold_11 = DecimalParameter(0.05, 0.4, default=0.374, space='buy', optimize=True)
    buy_dip_threshold_12 = DecimalParameter(0.2, 0.5, default=0.454, space='buy', optimize=True)

    # 24 hours
    buy_pump_pull_threshold_1 = DecimalParameter(1.5, 3.0, default=2.95, space='buy', optimize=True)
    buy_pump_threshold_1 = DecimalParameter(0.4, 1.0, default=0.607, space='buy', optimize=True)
    # 36 hours
    buy_pump_pull_threshold_2 = DecimalParameter(1.5, 3.0, default=2.82, space='buy', optimize=True)
    buy_pump_threshold_2 = DecimalParameter(0.4, 1.0, default=0.63, space='buy', optimize=True)
    # 48 hours
    buy_pump_pull_threshold_3 = DecimalParameter(1.5, 3.0, default=1.57, space='buy', optimize=True)
    buy_pump_threshold_3 = DecimalParameter(0.4, 1.0, default=0.675, space='buy', optimize=True)

    # 24 hours strict
    buy_pump_pull_threshold_4 = DecimalParameter(1.5, 3.0, default=1.54, space='buy', optimize=True)
    buy_pump_threshold_4 = DecimalParameter(0.4, 1.0, default=0.441, space='buy', optimize=True)
    # 36 hours strict
    buy_pump_pull_threshold_5 = DecimalParameter(1.5, 3.0, default=2.26, space='buy', optimize=True)
    buy_pump_threshold_5 = DecimalParameter(0.4, 1.0, default=0.421, space='buy', optimize=True)
    # 48 hours strict
    buy_pump_pull_threshold_6 = DecimalParameter(1.5, 3.0, default=2.21, space='buy', optimize=True)
    buy_pump_threshold_6 = DecimalParameter(0.4, 1.0, default=0.501, space='buy', optimize=True)

    # 24 hours loose
    buy_pump_pull_threshold_7 = DecimalParameter(1.5, 3.0, default=1.79, space='buy', optimize=True)
    buy_pump_threshold_7 = DecimalParameter(0.4, 1.0, default=0.547, space='buy', optimize=True)
    # 36 hours loose
    buy_pump_pull_threshold_8 = DecimalParameter(1.5, 3.0, default=2.61, space='buy', optimize=True)
    buy_pump_threshold_8 = DecimalParameter(0.4, 1.0, default=0.522, space='buy', optimize=True)
    # 48 hours loose
    buy_pump_pull_threshold_9 = DecimalParameter(1.5, 3.0, default=1.88, space='buy', optimize=True)
    buy_pump_threshold_9 = DecimalParameter(0.4, 1.8, default=1.063, space='buy', optimize=True)

    buy_min_inc_1 = DecimalParameter(0.01, 0.05, default=0.016, space='buy', optimize=True)
    buy_rsi_1h_min_1 = DecimalParameter(25.0, 40.0, default=34.5, space='buy', optimize=True)
    buy_rsi_1h_max_1 = DecimalParameter(70.0, 90.0, default=84.7, space='buy', optimize=True)
    buy_rsi_1 = DecimalParameter(20.0, 40.0, default=24.3, space='buy', optimize=True)
    buy_mfi_1 = DecimalParameter(20.0, 40.0, default=23.3, space='buy', optimize=True)

    buy_volume_2 = DecimalParameter(1.0, 10.0, default=7.1, space='buy', optimize=True)
    buy_rsi_1h_min_2 = DecimalParameter(30.0, 40.0, default=32.3, space='buy', optimize=True)
    buy_rsi_1h_max_2 = DecimalParameter(70.0, 95.0, default=74.1, space='buy', optimize=True)
    buy_rsi_1h_diff_2 = DecimalParameter(30.0, 50.0, default=40.6, space='buy', optimize=True)
    buy_mfi_2 = DecimalParameter(30.0, 56.0, default=31.9, space='buy', optimize=True)
    buy_bb_offset_2 = DecimalParameter(0.97, 0.999, default=0.974, space='buy', optimize=True)
    ...
    buy_ema_rel_3 = DecimalParameter(0.97, 0.999, default=0.974, space='buy', optimize=True)

    buy_bb20_close_bblowerband_4 = DecimalParameter(0.96, 0.99, default=1.0, space='buy', optimize=True)
    buy_bb20_volume_4 = DecimalParameter(1.0, 20.0, default=11.92, space='buy', optimize=True)

    buy_ema_open_mult_5 = DecimalParameter(0.016, 0.03, default=0.018, space='buy', optimize=True)
    buy_bb_offset_5 = DecimalParameter(0.98, 1.0, default=1.0, space='buy', optimize=True)
    buy_ema_rel_5 = DecimalParameter(0.97, 0.999, default=0.991, space='buy', optimize=True)
    ...
    buy_volume_7 = DecimalParameter(1.0, 10.0, default=1.3, space='buy', optimize=True)
    buy_ema_open_mult_7 = DecimalParameter(0.02, 0.04, default=0.025, space='buy', optimize=True)
    buy_rsi_7 = DecimalParameter(24.0, 50.0, default=42.1, space='buy', optimize=True)
    buy_ema_rel_7 = DecimalParameter(0.97, 0.999, default=0.989, space='buy', optimize=True)

    buy_volume_8 = DecimalParameter(1.0, 6.0, default=4.3, space='buy', optimize=True)
    buy_rsi_8 = DecimalParameter(36.0, 40.0, default=37.4, space='buy', optimize=True)
    buy_tail_diff_8 = DecimalParameter(3.0, 10.0, default=9.4, space='buy', optimize=True)

    buy_volume_9 = DecimalParameter(1.0, 4.0, default=1.7, space='buy', optimize=True)
    buy_ma_offset_9 = DecimalParameter(0.94, 0.99, default=0.968, space='buy', optimize=True)
    buy_bb_offset_9 = DecimalParameter(0.97, 0.99, default=0.98, space='buy', optimize=True)
    buy_rsi_1h_min_9 = DecimalParameter(26.0, 40.0, default=32.4, space='buy', optimize=True)
    buy_rsi_1h_max_9 = DecimalParameter(70.0, 90.0, default=85.0, space='buy', optimize=True)
    buy_mfi_9 = DecimalParameter(36.0, 65.0, default=40.4, space='buy', optimize=True)

    buy_volume_10 = DecimalParameter(1.0, 8.0, default=5.2, space='buy', optimize=True)
    buy_ma_offset_10 = DecimalParameter(0.93, 0.97, default=0.956, space='buy', optimize=True)
    buy_bb_offset_10 = DecimalParameter(0.97, 0.99, default=0.977, space='buy', optimize=True)
    buy_rsi_1h_10 = DecimalParameter(20.0, 40.0, default=31.3, space='buy', optimize=True)

    buy_ma_offset_11 = DecimalParameter(0.93, 0.99, default=0.956, space='buy', optimize=True)
    buy_min_inc_11 = DecimalParameter(0.005, 0.05, default=0.025, space='buy', optimize=True)
    buy_rsi_1h_min_11 = DecimalParameter(40.0, 60.0, default=46.2, space='buy', optimize=True)
    buy_rsi_1h_max_11 = DecimalParameter(70.0, 90.0, default=74.2, space='buy', optimize=True)
    buy_rsi_11 = DecimalParameter(30.0, 48.0, default=30.7, space='buy', optimize=True)
    buy_mfi_11 = DecimalParameter(36.0, 56.0, default=45.3, space='buy', optimize=True)

    buy_volume_12 = DecimalParameter(1.0, 10.0, default=1.2, space='buy', optimize=True)
    buy_ma_offset_12 = DecimalParameter(0.93, 0.97, default=0.97, space='buy', optimize=True)
    buy_rsi_12 = DecimalParameter(26.0, 40.0, default=30.4, space='buy', optimize=True)
    buy_ewo_12 = DecimalParameter(2.0, 6.0, default=2.4, space='buy', optimize=True)

    buy_volume_13 = DecimalParameter(1.0, 10.0, default=8.3, space='buy', optimize=True)
    buy_ma_offset_13 = DecimalParameter(0.93, 0.98, default=0.936, space='buy', optimize=True)
    buy_ewo_13 = DecimalParameter(-14.0, -7.0, default=-7.5, space='buy', optimize=True)

    buy_volume_14 = DecimalParameter(1.0, 10.0, default=5.4, space='buy', optimize=True)
    buy_ema_open_mult_14 = DecimalParameter(0.01, 0.03, default=0.02, space='buy', optimize=True)
    buy_bb_offset_14 = DecimalParameter(0.98, 1.0, default=0.987, space='buy', optimize=True)
    buy_ma_offset_14 = DecimalParameter(0.93, 0.99, default=0.934, space='buy', optimize=True)

    buy_volume_15 = DecimalParameter(1.0, 10.0, default=9.3, space='buy', optimize=True)
    buy_ema_open_mult_15 = DecimalParameter(0.02, 0.04, default=0.03, space='buy', optimize=True)
    buy_ma_offset_15 = DecimalParameter(0.93, 0.99, default=0.963, space='buy', optimize=True)
    buy_rsi_15 = DecimalParameter(30.0, 50.0, default=38.3, space='buy', optimize=True)
    buy_ema_rel_15 = DecimalParameter(0.97, 0.999, default=0.979, space='buy', optimize=True)

    buy_volume_16 = DecimalParameter(1.0, 10.0, default=2.5, space='buy', optimize=True)
    buy_ma_offset_16 = DecimalParameter(0.93, 0.97, default=0.933, space='buy', optimize=True)
    buy_rsi_16 = DecimalParameter(26.0, 50.0, default=28.9, space='buy', optimize=True)
    ...
    buy_ma_offset_17 = DecimalParameter(0.93, 0.98, default=0.968, space='buy', optimize=True)
    buy_ewo_17 = DecimalParameter(-18.0, -10.0, default=-17.8, space='buy', optimize=True)

    buy_volume_18 = DecimalParameter(1.0, 6.0, default=4.9, space='buy', optimize=True)
    buy_rsi_18 = DecimalParameter(16.0, 32.0, default=30.2, space='buy', optimize=True)
    buy_bb_offset_18 = DecimalParameter(0.98, 1.0, default=0.997, space='buy', optimize=True)

    buy_rsi_1h_min_19 = DecimalParameter(40.0, 70.0, default=47.4, space='buy', optimize=True)
    buy_chop_min_19 = DecimalParameter(20.0, 60.0, default=35.4, space='buy', optimize=True)

    buy_volume_20 = DecimalParameter(0.5, 6.0, default=1.9, space='buy', optimize=True)
    #buy_ema_rel_20 = DecimalParameter(0.97, 0.999, default=0.993, space='buy', optimize=True)
    buy_rsi_20 = DecimalParameter(20.0, 36.0, default=34.2, space='buy', optimize=True)
    buy_rsi_1h_20 = DecimalParameter(14.0, 30.0, default=14.6, space='buy', optimize=True)

    buy_volume_21 = DecimalParameter(0.5, 6.0, default=2.9, space='buy', optimize=True)
    #buy_ema_rel_21 = DecimalParameter(0.97, 0.999, default=0.987, space='buy', optimize=True)
    buy_rsi_21 = DecimalParameter(10.0, 28.0, default=16.0, space='buy', optimize=True)
    buy_rsi_1h_21 = DecimalParameter(18.0, 40.0, default=25.3, space='buy', optimize=True)
    ...
    sell_rsi_bb_1 = DecimalParameter(60.0, 80.0, default=76.6, space='sell', optimize=True)

    sell_rsi_bb_2 = DecimalParameter(72.0, 90.0, default=89.2, space='sell', optimize=True)

    sell_rsi_main_3 = DecimalParameter(77.0, 90.0, default=86.9, space='sell', optimize=True)

    sell_dual_rsi_rsi_4 = DecimalParameter(72.0, 84.0, default=75.2, space='sell', optimize=True)
    sell_dual_rsi_rsi_1h_4 = DecimalParameter(78.0, 92.0, default=83.2, space='sell', optimize=True)

    sell_ema_relative_5 = DecimalParameter(0.005, 0.05, default=0.0, space='sell', optimize=True)
    sell_rsi_diff_5 = DecimalParameter(0.0, 20.0, default=15.0, space='sell', optimize=True)

    sell_rsi_under_6 = DecimalParameter(72.0, 90.0, default=78.0, space='sell', optimize=True)

    sell_rsi_1h_7 = DecimalParameter(80.0, 95.0, default=92.4, space='sell', optimize=True)

    sell_bb_relative_8 = DecimalParameter(1.05, 1.3, default=1.176, space='sell', optimize=True)

    sell_custom_profit_0 = DecimalParameter(0.01, 0.1, default=0.032, space='sell', optimize=True)
    sell_custom_rsi_0 = DecimalParameter(30.0, 40.0, default=32.911, space='sell', optimize=True)
    sell_custom_profit_1 = DecimalParameter(0.01, 0.1, default=0.02, space='sell', optimize=True)
    sell_custom_rsi_1 = DecimalParameter(30.0, 50.0, default=48.74, space='sell', optimize=True)
    sell_custom_profit_2 = DecimalParameter(0.01, 0.1, default=0.058, space='sell', optimize=True)
    sell_custom_rsi_2 = DecimalParameter(34.0, 50.0, default=39.56, space='sell', optimize=True)
    sell_custom_profit_3 = DecimalParameter(0.06, 0.3, default=0.077, space='sell', optimize=True)
    sell_custom_rsi_3 = DecimalParameter(38.0, 55.0, default=44.92, space='sell', optimize=True)
    sell_custom_profit_4 = DecimalParameter(0.3, 0.6, default=0.5, space='sell', optimize=True)
    sell_custom_rsi_4 = DecimalParameter(40.0, 58.0, default=49.53, space='sell', optimize=True)

    sell_custom_under_profit_1 = DecimalParameter(0.01, 0.1, default=0.049, space='sell', optimize=True)
    sell_custom_under_rsi_1 = DecimalParameter(36.0, 60.0, default=55.5, space='sell', optimize=True)
    sell_custom_under_profit_2 = DecimalParameter(0.01, 0.1, default=0.022, space='sell', optimize=True)
    sell_custom_under_rsi_2 = DecimalParameter(46.0, 66.0, default=62.3, space='sell', optimize=True)
    sell_custom_under_profit_3 = DecimalParameter(0.01, 0.1, default=0.071, space='sell', optimize=True)
    sell_custom_under_rsi_3 = DecimalParameter(50.0, 68.0, default=57.6, space='sell', optimize=True)

    sell_custom_dec_profit_1 = DecimalParameter(0.01, 0.1, default=0.062, space='sell', optimize=True)
    sell_custom_dec_profit_2 = DecimalParameter(0.05, 0.2, default=0.161, space='sell', optimize=True)

    sell_trail_profit_min_1 = DecimalParameter(0.1, 0.25, default=0.218, space='sell', optimize=True)
    sell_trail_profit_max_1 = DecimalParameter(0.3, 0.5, default=0.32, space='sell', optimize=True)
    sell_trail_down_1 = DecimalParameter(0.04, 0.2, default=0.183, space='sell', optimize=True)

    sell_trail_profit_min_2 = DecimalParameter(0.01, 0.1, default=0.086, space='sell', optimize=True)
    sell_trail_profit_max_2 = DecimalParameter(0.08, 0.25, default=0.14, space='sell', optimize=True)
    sell_trail_down_2 = DecimalParameter(0.04, 0.2, default=0.169, space='sell', optimize=True)

    sell_trail_profit_min_3 = DecimalParameter(0.01, 0.1, default=0.074, space='sell', optimize=True)
    sell_trail_profit_max_3 = DecimalParameter(0.08, 0.16, default=0.15, space='sell', optimize=True)
    ...
    sell_custom_profit_under_rsi_diff_1 = DecimalParameter(0.0, 20.0, default=13.0, space='sell', optimize=True)

    sell_custom_stoploss_under_rel_1 = DecimalParameter(0.001, 0.02, default=0.0, space='sell', optimize=True)
    sell_custom_stoploss_under_rsi_diff_1 = DecimalParameter(0.0, 20.0, default=19.0, space='sell', optimize=True)
