...
class GeneTrader_gen1_1733515384_9641(IStrategy):
    INTERFACE_VERSION = 2
    ...
    # Multi Offset
    base_nb_candles_buy = IntParameter(5.0, 80.0, default=49, space='buy', optimize=True)
    base_nb_candles_sell = IntParameter(5.0, 80.0, default=38, space='sell', optimize=True)
    low_offset_sma = DecimalParameter(0.9, 0.99, default=0.98, space='buy', optimize=True)
    ...
    high_offset_trima = DecimalParameter(0.99, 1.1, default=1.05, space='sell', optimize=True)
    ...
    low_offset_kama = DecimalParameter(0.9, 0.99, default=0.91, space='buy', optimize=True)
    high_offset_kama = DecimalParameter(0.99, 1.1, default=1.0, space='sell', optimize=True)

    # Protection
    ewo_low = DecimalParameter(-20.0, -8.0, default=-14.7, space='buy', optimize=True)
    ewo_high = DecimalParameter(2.0, 12.0, default=7.3, space='buy', optimize=True)
    fast_ewo = IntParameter(10.0, 50.0, default=21, space='buy', optimize=True)
    ...
    # Normal dips
    buy_dip_threshold_1 = DecimalParameter(0.001, 0.05, default=0.034, space='buy', optimize=True)
    buy_dip_threshold_2 = DecimalParameter(0.01, 0.2, default=0.132, space='buy', optimize=True)
    buy_dip_threshold_3 = DecimalParameter(0.05, 0.4, default=0.056, space='buy', optimize=True)
    buy_dip_threshold_4 = DecimalParameter(0.2, 0.5, default=0.279, space='buy', optimize=True)
    # Strict dips
    buy_dip_threshold_5 = DecimalParameter(0.001, 0.05, default=0.047, space='buy', optimize=True)
    buy_dip_threshold_6 = DecimalParameter(0.01, 0.2, default=0.116, space='buy', optimize=True)
    buy_dip_threshold_7 = DecimalParameter(0.05, 0.4, default=0.262, space='buy', optimize=True)
    buy_dip_threshold_8 = DecimalParameter(0.2, 0.5, default=0.455, space='buy', optimize=True)
    # Loose dips
    buy_dip_threshold_9 = DecimalParameter(0.001, 0.05, default=0.043, space='buy', optimize=True)
    buy_dip_threshold_10 = DecimalParameter(0.01, 0.2, default=0.175, space='buy', optimize=True)
    buy_dip_threshold_11 = DecimalParameter(0.05, 0.4, default=0.164, space='buy', optimize=True)
    buy_dip_threshold_12 = DecimalParameter(0.2, 0.5, default=0.394, space='buy', optimize=True)

    # 24 hours
    buy_pump_pull_threshold_1 = DecimalParameter(1.5, 3.0, default=2.49, space='buy', optimize=True)
    buy_pump_threshold_1 = DecimalParameter(0.4, 1.0, default=0.895, space='buy', optimize=True)
    # 36 hours
    buy_pump_pull_threshold_2 = DecimalParameter(1.5, 3.0, default=1.72, space='buy', optimize=True)
    buy_pump_threshold_2 = DecimalParameter(0.4, 1.0, default=0.59, space='buy', optimize=True)
    # 48 hours
    buy_pump_pull_threshold_3 = DecimalParameter(1.5, 3.0, default=2.33, space='buy', optimize=True)
    buy_pump_threshold_3 = DecimalParameter(0.4, 1.0, default=0.617, space='buy', optimize=True)

    # 24 hours strict
    buy_pump_pull_threshold_4 = DecimalParameter(1.5, 3.0, default=1.74, space='buy', optimize=True)
    buy_pump_threshold_4 = DecimalParameter(0.4, 1.0, default=0.545, space='buy', optimize=True)
    # 36 hours strict
    buy_pump_pull_threshold_5 = DecimalParameter(1.5, 3.0, default=2.46, space='buy', optimize=True)
    buy_pump_threshold_5 = DecimalParameter(0.4, 1.0, default=0.547, space='buy', optimize=True)
    # 48 hours strict
    buy_pump_pull_threshold_6 = DecimalParameter(1.5, 3.0, default=2.94, space='buy', optimize=True)
    buy_pump_threshold_6 = DecimalParameter(0.4, 1.0, default=0.564, space='buy', optimize=True)

    # 24 hours loose
    buy_pump_pull_threshold_7 = DecimalParameter(1.5, 3.0, default=2.5, space='buy', optimize=True)
    buy_pump_threshold_7 = DecimalParameter(0.4, 1.0, default=0.947, space='buy', optimize=True)
    # 36 hours loose
    buy_pump_pull_threshold_8 = DecimalParameter(1.5, 3.0, default=2.53, space='buy', optimize=True)
    buy_pump_threshold_8 = DecimalParameter(0.4, 1.0, default=0.595, space='buy', optimize=True)
    # 48 hours loose
    buy_pump_pull_threshold_9 = DecimalParameter(1.5, 3.0, default=1.96, space='buy', optimize=True)
    buy_pump_threshold_9 = DecimalParameter(0.4, 1.8, default=1.485, space='buy', optimize=True)

    buy_min_inc_1 = DecimalParameter(0.01, 0.05, default=0.015, space='buy', optimize=True)
    buy_rsi_1h_min_1 = DecimalParameter(25.0, 40.0, default=34.6, space='buy', optimize=True)
    buy_rsi_1h_max_1 = DecimalParameter(70.0, 90.0, default=72.9, space='buy', optimize=True)
    buy_rsi_1 = DecimalParameter(20.0, 40.0, default=23.9, space='buy', optimize=True)
    buy_mfi_1 = DecimalParameter(20.0, 40.0, default=29.1, space='buy', optimize=True)

    buy_volume_2 = DecimalParameter(1.0, 10.0, default=4.9, space='buy', optimize=True)
    buy_rsi_1h_min_2 = DecimalParameter(30.0, 40.0, default=34.7, space='buy', optimize=True)
    buy_rsi_1h_max_2 = DecimalParameter(70.0, 95.0, default=76.3, space='buy', optimize=True)
    buy_rsi_1h_diff_2 = DecimalParameter(30.0, 50.0, default=37.0, space='buy', optimize=True)
    buy_mfi_2 = DecimalParameter(30.0, 56.0, default=43.6, space='buy', optimize=True)
    buy_bb_offset_2 = DecimalParameter(0.97, 0.999, default=0.983, space='buy', optimize=True)
    ...
    buy_ema_rel_3 = DecimalParameter(0.97, 0.999, default=0.971, space='buy', optimize=True)

    buy_bb20_close_bblowerband_4 = DecimalParameter(0.96, 0.99, default=1.0, space='buy', optimize=True)
    buy_bb20_volume_4 = DecimalParameter(1.0, 20.0, default=3.53, space='buy', optimize=True)

    buy_ema_open_mult_5 = DecimalParameter(0.016, 0.03, default=0.027, space='buy', optimize=True)
    buy_bb_offset_5 = DecimalParameter(0.98, 1.0, default=0.999, space='buy', optimize=True)
    buy_ema_rel_5 = DecimalParameter(0.97, 0.999, default=0.988, space='buy', optimize=True)

    buy_ema_open_mult_6 = DecimalParameter(0.02, 0.03, default=0.021, space='buy', optimize=True)
    buy_bb_offset_6 = DecimalParameter(0.98, 0.999, default=0.998, space='buy', optimize=True)

    buy_volume_7 = DecimalParameter(1.0, 10.0, default=6.2, space='buy', optimize=True)
    buy_ema_open_mult_7 = DecimalParameter(0.02, 0.04, default=0.037, space='buy', optimize=True)
    buy_rsi_7 = DecimalParameter(24.0, 50.0, default=35.5, space='buy', optimize=True)
    buy_ema_rel_7 = DecimalParameter(0.97, 0.999, default=0.991, space='buy', optimize=True)
    ...
    buy_tail_diff_8 = DecimalParameter(3.0, 10.0, default=3.4, space='buy', optimize=True)

    buy_volume_9 = DecimalParameter(1.0, 4.0, default=3.94, space='buy', optimize=True)
    buy_ma_offset_9 = DecimalParameter(0.94, 0.99, default=0.987, space='buy', optimize=True)
    buy_bb_offset_9 = DecimalParameter(0.97, 0.99, default=0.979, space='buy', optimize=True)
    buy_rsi_1h_min_9 = DecimalParameter(26.0, 40.0, default=33.8, space='buy', optimize=True)
    buy_rsi_1h_max_9 = DecimalParameter(70.0, 90.0, default=82.0, space='buy', optimize=True)
    buy_mfi_9 = DecimalParameter(36.0, 65.0, default=63.4, space='buy', optimize=True)

    buy_volume_10 = DecimalParameter(1.0, 8.0, default=5.6, space='buy', optimize=True)
    buy_ma_offset_10 = DecimalParameter(0.93, 0.97, default=0.931, space='buy', optimize=True)
    buy_bb_offset_10 = DecimalParameter(0.97, 0.99, default=0.976, space='buy', optimize=True)
    buy_rsi_1h_10 = DecimalParameter(20.0, 40.0, default=26.1, space='buy', optimize=True)

    buy_ma_offset_11 = DecimalParameter(0.93, 0.99, default=0.954, space='buy', optimize=True)
    buy_min_inc_11 = DecimalParameter(0.005, 0.05, default=0.028, space='buy', optimize=True)
    buy_rsi_1h_min_11 = DecimalParameter(40.0, 60.0, default=57.9, space='buy', optimize=True)
    buy_rsi_1h_max_11 = DecimalParameter(70.0, 90.0, default=86.6, space='buy', optimize=True)
    buy_rsi_11 = DecimalParameter(30.0, 48.0, default=34.4, space='buy', optimize=True)
    buy_mfi_11 = DecimalParameter(36.0, 56.0, default=45.8, space='buy', optimize=True)

    buy_volume_12 = DecimalParameter(1.0, 10.0, default=8.1, space='buy', optimize=True)
    buy_ma_offset_12 = DecimalParameter(0.93, 0.97, default=0.958, space='buy', optimize=True)
    buy_rsi_12 = DecimalParameter(26.0, 40.0, default=36.1, space='buy', optimize=True)
    buy_ewo_12 = DecimalParameter(2.0, 6.0, default=4.1, space='buy', optimize=True)

    buy_volume_13 = DecimalParameter(1.0, 10.0, default=2.5, space='buy', optimize=True)
    buy_ma_offset_13 = DecimalParameter(0.93, 0.98, default=0.95, space='buy', optimize=True)
    buy_ewo_13 = DecimalParameter(-14.0, -7.0, default=-9.6, space='buy', optimize=True)

    buy_volume_14 = DecimalParameter(1.0, 10.0, default=4.2, space='buy', optimize=True)
    buy_ema_open_mult_14 = DecimalParameter(0.01, 0.03, default=0.014, space='buy', optimize=True)
    buy_bb_offset_14 = DecimalParameter(0.98, 1.0, default=0.992, space='buy', optimize=True)
    buy_ma_offset_14 = DecimalParameter(0.93, 0.99, default=0.971, space='buy', optimize=True)

    buy_volume_15 = DecimalParameter(1.0, 10.0, default=2.1, space='buy', optimize=True)
    buy_ema_open_mult_15 = DecimalParameter(0.02, 0.04, default=0.028, space='buy', optimize=True)
    buy_ma_offset_15 = DecimalParameter(0.93, 0.99, default=0.944, space='buy', optimize=True)
    buy_rsi_15 = DecimalParameter(30.0, 50.0, default=48.9, space='buy', optimize=True)
    buy_ema_rel_15 = DecimalParameter(0.97, 0.999, default=0.994, space='buy', optimize=True)

    buy_volume_16 = DecimalParameter(1.0, 10.0, default=3.3, space='buy', optimize=True)
    buy_ma_offset_16 = DecimalParameter(0.93, 0.97, default=0.957, space='buy', optimize=True)
    buy_rsi_16 = DecimalParameter(26.0, 50.0, default=36.0, space='buy', optimize=True)
    buy_ewo_16 = DecimalParameter(4.0, 8.0, default=5.5, space='buy', optimize=True)

    buy_volume_17 = DecimalParameter(0.5, 8.0, default=1.7, space='buy', optimize=True)
    buy_ma_offset_17 = DecimalParameter(0.93, 0.98, default=0.957, space='buy', optimize=True)
    buy_ewo_17 = DecimalParameter(-18.0, -10.0, default=-10.1, space='buy', optimize=True)

    buy_volume_18 = DecimalParameter(1.0, 6.0, default=5.5, space='buy', optimize=True)
    buy_rsi_18 = DecimalParameter(16.0, 32.0, default=30.1, space='buy', optimize=True)
    buy_bb_offset_18 = DecimalParameter(0.98, 1.0, default=0.989, space='buy', optimize=True)

    buy_rsi_1h_min_19 = DecimalParameter(40.0, 70.0, default=40.3, space='buy', optimize=True)
    buy_chop_min_19 = DecimalParameter(20.0, 60.0, default=23.5, space='buy', optimize=True)

    buy_volume_20 = DecimalParameter(0.5, 6.0, default=1.7, space='buy', optimize=True)
    #buy_ema_rel_20 = DecimalParameter(0.97, 0.999, default=0.971, space='buy', optimize=True)
    buy_rsi_20 = DecimalParameter(20.0, 36.0, default=21.3, space='buy', optimize=True)
    buy_rsi_1h_20 = DecimalParameter(14.0, 30.0, default=27.3, space='buy', optimize=True)

    buy_volume_21 = DecimalParameter(0.5, 6.0, default=2.1, space='buy', optimize=True)
    ...
    buy_rsi_1h_21 = DecimalParameter(18.0, 40.0, default=36.0, space='buy', optimize=True)
    ...
    sell_rsi_bb_1 = DecimalParameter(60.0, 80.0, default=77.2, space='sell', optimize=True)

    sell_rsi_bb_2 = DecimalParameter(72.0, 90.0, default=81.4, space='sell', optimize=True)

    sell_rsi_main_3 = DecimalParameter(77.0, 90.0, default=84.1, space='sell', optimize=True)

    sell_dual_rsi_rsi_4 = DecimalParameter(72.0, 84.0, default=79.9, space='sell', optimize=True)
    sell_dual_rsi_rsi_1h_4 = DecimalParameter(78.0, 92.0, default=87.4, space='sell', optimize=True)
    ...
    sell_rsi_under_6 = DecimalParameter(72.0, 90.0, default=75.8, space='sell', optimize=True)

    sell_rsi_1h_7 = DecimalParameter(80.0, 95.0, default=87.0, space='sell', optimize=True)

    sell_bb_relative_8 = DecimalParameter(1.05, 1.3, default=1.231, space='sell', optimize=True)

    sell_custom_profit_0 = DecimalParameter(0.01, 0.1, default=0.076, space='sell', optimize=True)
    sell_custom_rsi_0 = DecimalParameter(30.0, 40.0, default=38.372, space='sell', optimize=True)
    sell_custom_profit_1 = DecimalParameter(0.01, 0.1, default=0.089, space='sell', optimize=True)
    sell_custom_rsi_1 = DecimalParameter(30.0, 50.0, default=30.17, space='sell', optimize=True)
    sell_custom_profit_2 = DecimalParameter(0.01, 0.1, default=0.034, space='sell', optimize=True)
    sell_custom_rsi_2 = DecimalParameter(34.0, 50.0, default=34.86, space='sell', optimize=True)
    sell_custom_profit_3 = DecimalParameter(0.06, 0.3, default=0.074, space='sell', optimize=True)
    sell_custom_rsi_3 = DecimalParameter(38.0, 55.0, default=46.32, space='sell', optimize=True)
    sell_custom_profit_4 = DecimalParameter(0.3, 0.6, default=0.391, space='sell', optimize=True)
    sell_custom_rsi_4 = DecimalParameter(40.0, 58.0, default=43.81, space='sell', optimize=True)

    sell_custom_under_profit_1 = DecimalParameter(0.01, 0.1, default=0.02, space='sell', optimize=True)
    sell_custom_under_rsi_1 = DecimalParameter(36.0, 60.0, default=38.2, space='sell', optimize=True)
    sell_custom_under_profit_2 = DecimalParameter(0.01, 0.1, default=0.05, space='sell', optimize=True)
    sell_custom_under_rsi_2 = DecimalParameter(46.0, 66.0, default=59.4, space='sell', optimize=True)
    sell_custom_under_profit_3 = DecimalParameter(0.01, 0.1, default=0.052, space='sell', optimize=True)
    sell_custom_under_rsi_3 = DecimalParameter(50.0, 68.0, default=57.7, space='sell', optimize=True)

    sell_custom_dec_profit_1 = DecimalParameter(0.01, 0.1, default=0.09, space='sell', optimize=True)
    sell_custom_dec_profit_2 = DecimalParameter(0.05, 0.2, default=0.188, space='sell', optimize=True)

    sell_trail_profit_min_1 = DecimalParameter(0.1, 0.25, default=0.162, space='sell', optimize=True)
    sell_trail_profit_max_1 = DecimalParameter(0.3, 0.5, default=0.46, space='sell', optimize=True)
    sell_trail_down_1 = DecimalParameter(0.04, 0.2, default=0.05, space='sell', optimize=True)

    sell_trail_profit_min_2 = DecimalParameter(0.01, 0.1, default=0.067, space='sell', optimize=True)
    sell_trail_profit_max_2 = DecimalParameter(0.08, 0.25, default=0.19, space='sell', optimize=True)
    sell_trail_down_2 = DecimalParameter(0.04, 0.2, default=0.078, space='sell', optimize=True)

    sell_trail_profit_min_3 = DecimalParameter(0.01, 0.1, default=0.031, space='sell', optimize=True)
    sell_trail_profit_max_3 = DecimalParameter(0.08, 0.16, default=0.1, space='sell', optimize=True)
    sell_trail_down_3 = DecimalParameter(0.01, 0.04, default=0.037, space='sell', optimize=True)
    ...
    sell_custom_stoploss_under_rsi_diff_1 = DecimalParameter(0.0, 20.0, default=17.0, space='sell', optimize=True)
