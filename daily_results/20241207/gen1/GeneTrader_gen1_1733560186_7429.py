...
class GeneTrader_gen1_1733560186_7429(IStrategy):
    INTERFACE_VERSION = 2
    ...
    # Multi Offset
    base_nb_candles_buy = IntParameter(5.0, 80.0, default=38, space='buy', optimize=True)
    base_nb_candles_sell = IntParameter(5.0, 80.0, default=59, space='sell', optimize=True)
    ...
    high_offset_ema = DecimalParameter(0.99, 1.1, default=1.1, space='sell', optimize=True)
    ...
    # Protection
    ewo_low = DecimalParameter(-20.0, -8.0, default=-19.5, space='buy', optimize=True)
    ewo_high = DecimalParameter(2.0, 12.0, default=5.4, space='buy', optimize=True)
    fast_ewo = IntParameter(10.0, 50.0, default=41, space='buy', optimize=True)
    slow_ewo = IntParameter(100.0, 200.0, default=163, space='buy', optimize=True)
    ...
    buy_dip_threshold_2 = DecimalParameter(0.01, 0.2, default=0.094, space='buy', optimize=True)
    buy_dip_threshold_3 = DecimalParameter(0.05, 0.4, default=0.328, space='buy', optimize=True)
    buy_dip_threshold_4 = DecimalParameter(0.2, 0.5, default=0.28, space='buy', optimize=True)
    # Strict dips
    buy_dip_threshold_5 = DecimalParameter(0.001, 0.05, default=0.044, space='buy', optimize=True)
    buy_dip_threshold_6 = DecimalParameter(0.01, 0.2, default=0.113, space='buy', optimize=True)
    buy_dip_threshold_7 = DecimalParameter(0.05, 0.4, default=0.104, space='buy', optimize=True)
    buy_dip_threshold_8 = DecimalParameter(0.2, 0.5, default=0.435, space='buy', optimize=True)
    # Loose dips
    buy_dip_threshold_9 = DecimalParameter(0.001, 0.05, default=0.027, space='buy', optimize=True)
    buy_dip_threshold_10 = DecimalParameter(0.01, 0.2, default=0.153, space='buy', optimize=True)
    buy_dip_threshold_11 = DecimalParameter(0.05, 0.4, default=0.057, space='buy', optimize=True)
    buy_dip_threshold_12 = DecimalParameter(0.2, 0.5, default=0.449, space='buy', optimize=True)

    # 24 hours
    buy_pump_pull_threshold_1 = DecimalParameter(1.5, 3.0, default=1.84, space='buy', optimize=True)
    buy_pump_threshold_1 = DecimalParameter(0.4, 1.0, default=0.482, space='buy', optimize=True)
    # 36 hours
    buy_pump_pull_threshold_2 = DecimalParameter(1.5, 3.0, default=2.28, space='buy', optimize=True)
    buy_pump_threshold_2 = DecimalParameter(0.4, 1.0, default=0.882, space='buy', optimize=True)
    # 48 hours
    buy_pump_pull_threshold_3 = DecimalParameter(1.5, 3.0, default=2.76, space='buy', optimize=True)
    buy_pump_threshold_3 = DecimalParameter(0.4, 1.0, default=0.909, space='buy', optimize=True)

    # 24 hours strict
    buy_pump_pull_threshold_4 = DecimalParameter(1.5, 3.0, default=2.41, space='buy', optimize=True)
    buy_pump_threshold_4 = DecimalParameter(0.4, 1.0, default=0.943, space='buy', optimize=True)
    # 36 hours strict
    buy_pump_pull_threshold_5 = DecimalParameter(1.5, 3.0, default=1.61, space='buy', optimize=True)
    buy_pump_threshold_5 = DecimalParameter(0.4, 1.0, default=0.89, space='buy', optimize=True)
    # 48 hours strict
    buy_pump_pull_threshold_6 = DecimalParameter(1.5, 3.0, default=2.61, space='buy', optimize=True)
    buy_pump_threshold_6 = DecimalParameter(0.4, 1.0, default=0.785, space='buy', optimize=True)

    # 24 hours loose
    buy_pump_pull_threshold_7 = DecimalParameter(1.5, 3.0, default=2.95, space='buy', optimize=True)
    buy_pump_threshold_7 = DecimalParameter(0.4, 1.0, default=0.838, space='buy', optimize=True)
    # 36 hours loose
    buy_pump_pull_threshold_8 = DecimalParameter(1.5, 3.0, default=1.74, space='buy', optimize=True)
    buy_pump_threshold_8 = DecimalParameter(0.4, 1.0, default=0.611, space='buy', optimize=True)
    # 48 hours loose
    buy_pump_pull_threshold_9 = DecimalParameter(1.5, 3.0, default=2.53, space='buy', optimize=True)
    buy_pump_threshold_9 = DecimalParameter(0.4, 1.8, default=0.434, space='buy', optimize=True)

    buy_min_inc_1 = DecimalParameter(0.01, 0.05, default=0.019, space='buy', optimize=True)
    buy_rsi_1h_min_1 = DecimalParameter(25.0, 40.0, default=32.3, space='buy', optimize=True)
    buy_rsi_1h_max_1 = DecimalParameter(70.0, 90.0, default=73.1, space='buy', optimize=True)
    buy_rsi_1 = DecimalParameter(20.0, 40.0, default=37.4, space='buy', optimize=True)
    buy_mfi_1 = DecimalParameter(20.0, 40.0, default=23.0, space='buy', optimize=True)

    buy_volume_2 = DecimalParameter(1.0, 10.0, default=3.0, space='buy', optimize=True)
    buy_rsi_1h_min_2 = DecimalParameter(30.0, 40.0, default=33.4, space='buy', optimize=True)
    buy_rsi_1h_max_2 = DecimalParameter(70.0, 95.0, default=91.8, space='buy', optimize=True)
    buy_rsi_1h_diff_2 = DecimalParameter(30.0, 50.0, default=37.7, space='buy', optimize=True)
    buy_mfi_2 = DecimalParameter(30.0, 56.0, default=49.8, space='buy', optimize=True)
    buy_bb_offset_2 = DecimalParameter(0.97, 0.999, default=0.979, space='buy', optimize=True)
    ...
    buy_bb20_volume_4 = DecimalParameter(1.0, 20.0, default=7.87, space='buy', optimize=True)

    buy_ema_open_mult_5 = DecimalParameter(0.016, 0.03, default=0.017, space='buy', optimize=True)
    buy_bb_offset_5 = DecimalParameter(0.98, 1.0, default=0.996, space='buy', optimize=True)
    buy_ema_rel_5 = DecimalParameter(0.97, 0.999, default=0.992, space='buy', optimize=True)

    buy_ema_open_mult_6 = DecimalParameter(0.02, 0.03, default=0.025, space='buy', optimize=True)
    buy_bb_offset_6 = DecimalParameter(0.98, 0.999, default=0.997, space='buy', optimize=True)

    buy_volume_7 = DecimalParameter(1.0, 10.0, default=2.7, space='buy', optimize=True)
    buy_ema_open_mult_7 = DecimalParameter(0.02, 0.04, default=0.021, space='buy', optimize=True)
    buy_rsi_7 = DecimalParameter(24.0, 50.0, default=28.6, space='buy', optimize=True)
    buy_ema_rel_7 = DecimalParameter(0.97, 0.999, default=0.97, space='buy', optimize=True)
    ...
    buy_tail_diff_8 = DecimalParameter(3.0, 10.0, default=6.8, space='buy', optimize=True)

    buy_volume_9 = DecimalParameter(1.0, 4.0, default=1.51, space='buy', optimize=True)
    buy_ma_offset_9 = DecimalParameter(0.94, 0.99, default=0.95, space='buy', optimize=True)
    buy_bb_offset_9 = DecimalParameter(0.97, 0.99, default=0.975, space='buy', optimize=True)
    buy_rsi_1h_min_9 = DecimalParameter(26.0, 40.0, default=26.7, space='buy', optimize=True)
    buy_rsi_1h_max_9 = DecimalParameter(70.0, 90.0, default=83.3, space='buy', optimize=True)
    buy_mfi_9 = DecimalParameter(36.0, 65.0, default=53.7, space='buy', optimize=True)

    buy_volume_10 = DecimalParameter(1.0, 8.0, default=5.2, space='buy', optimize=True)
    buy_ma_offset_10 = DecimalParameter(0.93, 0.97, default=0.94, space='buy', optimize=True)
    buy_bb_offset_10 = DecimalParameter(0.97, 0.99, default=0.973, space='buy', optimize=True)
    buy_rsi_1h_10 = DecimalParameter(20.0, 40.0, default=21.3, space='buy', optimize=True)

    buy_ma_offset_11 = DecimalParameter(0.93, 0.99, default=0.95, space='buy', optimize=True)
    buy_min_inc_11 = DecimalParameter(0.005, 0.05, default=0.039, space='buy', optimize=True)
    buy_rsi_1h_min_11 = DecimalParameter(40.0, 60.0, default=49.6, space='buy', optimize=True)
    buy_rsi_1h_max_11 = DecimalParameter(70.0, 90.0, default=74.6, space='buy', optimize=True)
    buy_rsi_11 = DecimalParameter(30.0, 48.0, default=43.1, space='buy', optimize=True)
    buy_mfi_11 = DecimalParameter(36.0, 56.0, default=40.5, space='buy', optimize=True)

    buy_volume_12 = DecimalParameter(1.0, 10.0, default=1.7, space='buy', optimize=True)
    buy_ma_offset_12 = DecimalParameter(0.93, 0.97, default=0.931, space='buy', optimize=True)
    buy_rsi_12 = DecimalParameter(26.0, 40.0, default=32.8, space='buy', optimize=True)
    buy_ewo_12 = DecimalParameter(2.0, 6.0, default=2.1, space='buy', optimize=True)

    buy_volume_13 = DecimalParameter(1.0, 10.0, default=6.5, space='buy', optimize=True)
    buy_ma_offset_13 = DecimalParameter(0.93, 0.98, default=0.97, space='buy', optimize=True)
    buy_ewo_13 = DecimalParameter(-14.0, -7.0, default=-12.6, space='buy', optimize=True)

    buy_volume_14 = DecimalParameter(1.0, 10.0, default=3.9, space='buy', optimize=True)
    ...
    buy_ma_offset_14 = DecimalParameter(0.93, 0.99, default=0.961, space='buy', optimize=True)

    buy_volume_15 = DecimalParameter(1.0, 10.0, default=4.3, space='buy', optimize=True)
    buy_ema_open_mult_15 = DecimalParameter(0.02, 0.04, default=0.039, space='buy', optimize=True)
    buy_ma_offset_15 = DecimalParameter(0.93, 0.99, default=0.955, space='buy', optimize=True)
    buy_rsi_15 = DecimalParameter(30.0, 50.0, default=41.1, space='buy', optimize=True)
    buy_ema_rel_15 = DecimalParameter(0.97, 0.999, default=0.989, space='buy', optimize=True)

    buy_volume_16 = DecimalParameter(1.0, 10.0, default=6.8, space='buy', optimize=True)
    buy_ma_offset_16 = DecimalParameter(0.93, 0.97, default=0.943, space='buy', optimize=True)
    buy_rsi_16 = DecimalParameter(26.0, 50.0, default=42.2, space='buy', optimize=True)
    buy_ewo_16 = DecimalParameter(4.0, 8.0, default=5.4, space='buy', optimize=True)

    buy_volume_17 = DecimalParameter(0.5, 8.0, default=0.6, space='buy', optimize=True)
    buy_ma_offset_17 = DecimalParameter(0.93, 0.98, default=0.931, space='buy', optimize=True)
    buy_ewo_17 = DecimalParameter(-18.0, -10.0, default=-11.5, space='buy', optimize=True)

    buy_volume_18 = DecimalParameter(1.0, 6.0, default=1.5, space='buy', optimize=True)
    buy_rsi_18 = DecimalParameter(16.0, 32.0, default=26.8, space='buy', optimize=True)
    buy_bb_offset_18 = DecimalParameter(0.98, 1.0, default=0.995, space='buy', optimize=True)

    buy_rsi_1h_min_19 = DecimalParameter(40.0, 70.0, default=67.7, space='buy', optimize=True)
    buy_chop_min_19 = DecimalParameter(20.0, 60.0, default=49.2, space='buy', optimize=True)

    buy_volume_20 = DecimalParameter(0.5, 6.0, default=3.9, space='buy', optimize=True)
    ...
    buy_rsi_1h_20 = DecimalParameter(14.0, 30.0, default=25.3, space='buy', optimize=True)

    buy_volume_21 = DecimalParameter(0.5, 6.0, default=4.3, space='buy', optimize=True)
    #buy_ema_rel_21 = DecimalParameter(0.97, 0.999, default=0.982, space='buy', optimize=True)
    buy_rsi_21 = DecimalParameter(10.0, 28.0, default=20.1, space='buy', optimize=True)
    buy_rsi_1h_21 = DecimalParameter(18.0, 40.0, default=35.0, space='buy', optimize=True)
    ...
    sell_rsi_bb_1 = DecimalParameter(60.0, 80.0, default=77.9, space='sell', optimize=True)

    sell_rsi_bb_2 = DecimalParameter(72.0, 90.0, default=86.1, space='sell', optimize=True)

    sell_rsi_main_3 = DecimalParameter(77.0, 90.0, default=88.8, space='sell', optimize=True)

    sell_dual_rsi_rsi_4 = DecimalParameter(72.0, 84.0, default=84.0, space='sell', optimize=True)
    sell_dual_rsi_rsi_1h_4 = DecimalParameter(78.0, 92.0, default=81.2, space='sell', optimize=True)
    ...
    sell_rsi_under_6 = DecimalParameter(72.0, 90.0, default=81.7, space='sell', optimize=True)

    sell_rsi_1h_7 = DecimalParameter(80.0, 95.0, default=91.7, space='sell', optimize=True)

    sell_bb_relative_8 = DecimalParameter(1.05, 1.3, default=1.25, space='sell', optimize=True)

    sell_custom_profit_0 = DecimalParameter(0.01, 0.1, default=0.056, space='sell', optimize=True)
    sell_custom_rsi_0 = DecimalParameter(30.0, 40.0, default=33.521, space='sell', optimize=True)
    sell_custom_profit_1 = DecimalParameter(0.01, 0.1, default=0.098, space='sell', optimize=True)
    sell_custom_rsi_1 = DecimalParameter(30.0, 50.0, default=49.19, space='sell', optimize=True)
    sell_custom_profit_2 = DecimalParameter(0.01, 0.1, default=0.015, space='sell', optimize=True)
    sell_custom_rsi_2 = DecimalParameter(34.0, 50.0, default=35.54, space='sell', optimize=True)
    sell_custom_profit_3 = DecimalParameter(0.06, 0.3, default=0.254, space='sell', optimize=True)
    sell_custom_rsi_3 = DecimalParameter(38.0, 55.0, default=50.81, space='sell', optimize=True)
    sell_custom_profit_4 = DecimalParameter(0.3, 0.6, default=0.363, space='sell', optimize=True)
    sell_custom_rsi_4 = DecimalParameter(40.0, 58.0, default=41.59, space='sell', optimize=True)

    sell_custom_under_profit_1 = DecimalParameter(0.01, 0.1, default=0.082, space='sell', optimize=True)
    sell_custom_under_rsi_1 = DecimalParameter(36.0, 60.0, default=58.4, space='sell', optimize=True)
    sell_custom_under_profit_2 = DecimalParameter(0.01, 0.1, default=0.058, space='sell', optimize=True)
    sell_custom_under_rsi_2 = DecimalParameter(46.0, 66.0, default=46.6, space='sell', optimize=True)
    sell_custom_under_profit_3 = DecimalParameter(0.01, 0.1, default=0.011, space='sell', optimize=True)
    sell_custom_under_rsi_3 = DecimalParameter(50.0, 68.0, default=55.3, space='sell', optimize=True)

    sell_custom_dec_profit_1 = DecimalParameter(0.01, 0.1, default=0.034, space='sell', optimize=True)
    sell_custom_dec_profit_2 = DecimalParameter(0.05, 0.2, default=0.075, space='sell', optimize=True)

    sell_trail_profit_min_1 = DecimalParameter(0.1, 0.25, default=0.178, space='sell', optimize=True)
    sell_trail_profit_max_1 = DecimalParameter(0.3, 0.5, default=0.45, space='sell', optimize=True)
    sell_trail_down_1 = DecimalParameter(0.04, 0.2, default=0.178, space='sell', optimize=True)

    sell_trail_profit_min_2 = DecimalParameter(0.01, 0.1, default=0.085, space='sell', optimize=True)
    sell_trail_profit_max_2 = DecimalParameter(0.08, 0.25, default=0.14, space='sell', optimize=True)
    sell_trail_down_2 = DecimalParameter(0.04, 0.2, default=0.148, space='sell', optimize=True)

    sell_trail_profit_min_3 = DecimalParameter(0.01, 0.1, default=0.014, space='sell', optimize=True)
    sell_trail_profit_max_3 = DecimalParameter(0.08, 0.16, default=0.08, space='sell', optimize=True)
    ...
    sell_custom_profit_under_rsi_diff_1 = DecimalParameter(0.0, 20.0, default=5.0, space='sell', optimize=True)

    sell_custom_stoploss_under_rel_1 = DecimalParameter(0.001, 0.02, default=0.0, space='sell', optimize=True)
    sell_custom_stoploss_under_rsi_diff_1 = DecimalParameter(0.0, 20.0, default=10.0, space='sell', optimize=True)
