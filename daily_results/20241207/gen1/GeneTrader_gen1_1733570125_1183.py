...
class GeneTrader_gen1_1733570125_1183(IStrategy):
    INTERFACE_VERSION = 2
    ...
    # Multi Offset
    base_nb_candles_buy = IntParameter(5.0, 80.0, default=56, space='buy', optimize=True)
    base_nb_candles_sell = IntParameter(5.0, 80.0, default=34, space='sell', optimize=True)
    ...
    high_offset_ema = DecimalParameter(0.99, 1.1, default=1.02, space='sell', optimize=True)
    low_offset_trima = DecimalParameter(0.9, 0.99, default=0.99, space='buy', optimize=True)
    ...
    high_offset_t3 = DecimalParameter(0.99, 1.1, default=1.02, space='sell', optimize=True)
    ...
    # Protection
    ewo_low = DecimalParameter(-20.0, -8.0, default=-11.5, space='buy', optimize=True)
    ewo_high = DecimalParameter(2.0, 12.0, default=5.3, space='buy', optimize=True)
    fast_ewo = IntParameter(10.0, 50.0, default=40, space='buy', optimize=True)
    slow_ewo = IntParameter(100.0, 200.0, default=133, space='buy', optimize=True)
    ...
    buy_dip_threshold_2 = DecimalParameter(0.01, 0.2, default=0.058, space='buy', optimize=True)
    buy_dip_threshold_3 = DecimalParameter(0.05, 0.4, default=0.261, space='buy', optimize=True)
    buy_dip_threshold_4 = DecimalParameter(0.2, 0.5, default=0.37, space='buy', optimize=True)
    # Strict dips
    buy_dip_threshold_5 = DecimalParameter(0.001, 0.05, default=0.01, space='buy', optimize=True)
    buy_dip_threshold_6 = DecimalParameter(0.01, 0.2, default=0.144, space='buy', optimize=True)
    buy_dip_threshold_7 = DecimalParameter(0.05, 0.4, default=0.254, space='buy', optimize=True)
    buy_dip_threshold_8 = DecimalParameter(0.2, 0.5, default=0.467, space='buy', optimize=True)
    # Loose dips
    buy_dip_threshold_9 = DecimalParameter(0.001, 0.05, default=0.022, space='buy', optimize=True)
    buy_dip_threshold_10 = DecimalParameter(0.01, 0.2, default=0.177, space='buy', optimize=True)
    buy_dip_threshold_11 = DecimalParameter(0.05, 0.4, default=0.084, space='buy', optimize=True)
    buy_dip_threshold_12 = DecimalParameter(0.2, 0.5, default=0.268, space='buy', optimize=True)

    # 24 hours
    buy_pump_pull_threshold_1 = DecimalParameter(1.5, 3.0, default=1.97, space='buy', optimize=True)
    buy_pump_threshold_1 = DecimalParameter(0.4, 1.0, default=0.723, space='buy', optimize=True)
    # 36 hours
    buy_pump_pull_threshold_2 = DecimalParameter(1.5, 3.0, default=1.52, space='buy', optimize=True)
    buy_pump_threshold_2 = DecimalParameter(0.4, 1.0, default=0.947, space='buy', optimize=True)
    # 48 hours
    buy_pump_pull_threshold_3 = DecimalParameter(1.5, 3.0, default=2.39, space='buy', optimize=True)
    buy_pump_threshold_3 = DecimalParameter(0.4, 1.0, default=0.416, space='buy', optimize=True)

    # 24 hours strict
    buy_pump_pull_threshold_4 = DecimalParameter(1.5, 3.0, default=2.98, space='buy', optimize=True)
    buy_pump_threshold_4 = DecimalParameter(0.4, 1.0, default=0.418, space='buy', optimize=True)
    # 36 hours strict
    buy_pump_pull_threshold_5 = DecimalParameter(1.5, 3.0, default=1.52, space='buy', optimize=True)
    buy_pump_threshold_5 = DecimalParameter(0.4, 1.0, default=0.733, space='buy', optimize=True)
    # 48 hours strict
    buy_pump_pull_threshold_6 = DecimalParameter(1.5, 3.0, default=2.23, space='buy', optimize=True)
    buy_pump_threshold_6 = DecimalParameter(0.4, 1.0, default=0.415, space='buy', optimize=True)

    # 24 hours loose
    buy_pump_pull_threshold_7 = DecimalParameter(1.5, 3.0, default=2.91, space='buy', optimize=True)
    buy_pump_threshold_7 = DecimalParameter(0.4, 1.0, default=0.905, space='buy', optimize=True)
    # 36 hours loose
    buy_pump_pull_threshold_8 = DecimalParameter(1.5, 3.0, default=2.66, space='buy', optimize=True)
    buy_pump_threshold_8 = DecimalParameter(0.4, 1.0, default=0.83, space='buy', optimize=True)
    # 48 hours loose
    buy_pump_pull_threshold_9 = DecimalParameter(1.5, 3.0, default=2.09, space='buy', optimize=True)
    buy_pump_threshold_9 = DecimalParameter(0.4, 1.8, default=0.659, space='buy', optimize=True)

    buy_min_inc_1 = DecimalParameter(0.01, 0.05, default=0.043, space='buy', optimize=True)
    buy_rsi_1h_min_1 = DecimalParameter(25.0, 40.0, default=28.7, space='buy', optimize=True)
    buy_rsi_1h_max_1 = DecimalParameter(70.0, 90.0, default=86.8, space='buy', optimize=True)
    buy_rsi_1 = DecimalParameter(20.0, 40.0, default=39.8, space='buy', optimize=True)
    buy_mfi_1 = DecimalParameter(20.0, 40.0, default=39.8, space='buy', optimize=True)

    buy_volume_2 = DecimalParameter(1.0, 10.0, default=6.6, space='buy', optimize=True)
    buy_rsi_1h_min_2 = DecimalParameter(30.0, 40.0, default=38.7, space='buy', optimize=True)
    buy_rsi_1h_max_2 = DecimalParameter(70.0, 95.0, default=81.1, space='buy', optimize=True)
    buy_rsi_1h_diff_2 = DecimalParameter(30.0, 50.0, default=48.3, space='buy', optimize=True)
    buy_mfi_2 = DecimalParameter(30.0, 56.0, default=35.9, space='buy', optimize=True)
    ...
    buy_ema_rel_3 = DecimalParameter(0.97, 0.999, default=0.979, space='buy', optimize=True)

    buy_bb20_close_bblowerband_4 = DecimalParameter(0.96, 0.99, default=1.0, space='buy', optimize=True)
    buy_bb20_volume_4 = DecimalParameter(1.0, 20.0, default=19.17, space='buy', optimize=True)

    buy_ema_open_mult_5 = DecimalParameter(0.016, 0.03, default=0.018, space='buy', optimize=True)
    buy_bb_offset_5 = DecimalParameter(0.98, 1.0, default=0.988, space='buy', optimize=True)
    buy_ema_rel_5 = DecimalParameter(0.97, 0.999, default=0.973, space='buy', optimize=True)

    buy_ema_open_mult_6 = DecimalParameter(0.02, 0.03, default=0.029, space='buy', optimize=True)
    buy_bb_offset_6 = DecimalParameter(0.98, 0.999, default=0.991, space='buy', optimize=True)

    buy_volume_7 = DecimalParameter(1.0, 10.0, default=8.2, space='buy', optimize=True)
    buy_ema_open_mult_7 = DecimalParameter(0.02, 0.04, default=0.038, space='buy', optimize=True)
    buy_rsi_7 = DecimalParameter(24.0, 50.0, default=48.4, space='buy', optimize=True)
    buy_ema_rel_7 = DecimalParameter(0.97, 0.999, default=0.973, space='buy', optimize=True)

    buy_volume_8 = DecimalParameter(1.0, 6.0, default=3.8, space='buy', optimize=True)
    buy_rsi_8 = DecimalParameter(36.0, 40.0, default=37.5, space='buy', optimize=True)
    buy_tail_diff_8 = DecimalParameter(3.0, 10.0, default=4.9, space='buy', optimize=True)

    buy_volume_9 = DecimalParameter(1.0, 4.0, default=1.64, space='buy', optimize=True)
    buy_ma_offset_9 = DecimalParameter(0.94, 0.99, default=0.969, space='buy', optimize=True)
    buy_bb_offset_9 = DecimalParameter(0.97, 0.99, default=0.981, space='buy', optimize=True)
    buy_rsi_1h_min_9 = DecimalParameter(26.0, 40.0, default=26.1, space='buy', optimize=True)
    buy_rsi_1h_max_9 = DecimalParameter(70.0, 90.0, default=75.6, space='buy', optimize=True)
    buy_mfi_9 = DecimalParameter(36.0, 65.0, default=48.9, space='buy', optimize=True)

    buy_volume_10 = DecimalParameter(1.0, 8.0, default=2.2, space='buy', optimize=True)
    ...
    buy_rsi_1h_10 = DecimalParameter(20.0, 40.0, default=23.2, space='buy', optimize=True)

    buy_ma_offset_11 = DecimalParameter(0.93, 0.99, default=0.975, space='buy', optimize=True)
    buy_min_inc_11 = DecimalParameter(0.005, 0.05, default=0.04, space='buy', optimize=True)
    buy_rsi_1h_min_11 = DecimalParameter(40.0, 60.0, default=50.7, space='buy', optimize=True)
    buy_rsi_1h_max_11 = DecimalParameter(70.0, 90.0, default=80.6, space='buy', optimize=True)
    buy_rsi_11 = DecimalParameter(30.0, 48.0, default=46.8, space='buy', optimize=True)
    buy_mfi_11 = DecimalParameter(36.0, 56.0, default=52.6, space='buy', optimize=True)

    buy_volume_12 = DecimalParameter(1.0, 10.0, default=7.9, space='buy', optimize=True)
    buy_ma_offset_12 = DecimalParameter(0.93, 0.97, default=0.948, space='buy', optimize=True)
    buy_rsi_12 = DecimalParameter(26.0, 40.0, default=31.3, space='buy', optimize=True)
    buy_ewo_12 = DecimalParameter(2.0, 6.0, default=5.2, space='buy', optimize=True)

    buy_volume_13 = DecimalParameter(1.0, 10.0, default=2.7, space='buy', optimize=True)
    buy_ma_offset_13 = DecimalParameter(0.93, 0.98, default=0.946, space='buy', optimize=True)
    buy_ewo_13 = DecimalParameter(-14.0, -7.0, default=-8.2, space='buy', optimize=True)

    buy_volume_14 = DecimalParameter(1.0, 10.0, default=6.9, space='buy', optimize=True)
    buy_ema_open_mult_14 = DecimalParameter(0.01, 0.03, default=0.018, space='buy', optimize=True)
    buy_bb_offset_14 = DecimalParameter(0.98, 1.0, default=0.998, space='buy', optimize=True)
    buy_ma_offset_14 = DecimalParameter(0.93, 0.99, default=0.945, space='buy', optimize=True)

    buy_volume_15 = DecimalParameter(1.0, 10.0, default=6.2, space='buy', optimize=True)
    buy_ema_open_mult_15 = DecimalParameter(0.02, 0.04, default=0.021, space='buy', optimize=True)
    buy_ma_offset_15 = DecimalParameter(0.93, 0.99, default=0.938, space='buy', optimize=True)
    buy_rsi_15 = DecimalParameter(30.0, 50.0, default=31.0, space='buy', optimize=True)
    buy_ema_rel_15 = DecimalParameter(0.97, 0.999, default=0.984, space='buy', optimize=True)

    buy_volume_16 = DecimalParameter(1.0, 10.0, default=6.4, space='buy', optimize=True)
    buy_ma_offset_16 = DecimalParameter(0.93, 0.97, default=0.934, space='buy', optimize=True)
    buy_rsi_16 = DecimalParameter(26.0, 50.0, default=43.3, space='buy', optimize=True)
    buy_ewo_16 = DecimalParameter(4.0, 8.0, default=7.3, space='buy', optimize=True)

    buy_volume_17 = DecimalParameter(0.5, 8.0, default=1.2, space='buy', optimize=True)
    buy_ma_offset_17 = DecimalParameter(0.93, 0.98, default=0.939, space='buy', optimize=True)
    buy_ewo_17 = DecimalParameter(-18.0, -10.0, default=-10.2, space='buy', optimize=True)

    buy_volume_18 = DecimalParameter(1.0, 6.0, default=3.4, space='buy', optimize=True)
    buy_rsi_18 = DecimalParameter(16.0, 32.0, default=19.3, space='buy', optimize=True)
    buy_bb_offset_18 = DecimalParameter(0.98, 1.0, default=0.993, space='buy', optimize=True)

    buy_rsi_1h_min_19 = DecimalParameter(40.0, 70.0, default=57.8, space='buy', optimize=True)
    buy_chop_min_19 = DecimalParameter(20.0, 60.0, default=51.8, space='buy', optimize=True)

    buy_volume_20 = DecimalParameter(0.5, 6.0, default=5.8, space='buy', optimize=True)
    #buy_ema_rel_20 = DecimalParameter(0.97, 0.999, default=0.971, space='buy', optimize=True)
    buy_rsi_20 = DecimalParameter(20.0, 36.0, default=28.5, space='buy', optimize=True)
    buy_rsi_1h_20 = DecimalParameter(14.0, 30.0, default=14.2, space='buy', optimize=True)

    buy_volume_21 = DecimalParameter(0.5, 6.0, default=3.7, space='buy', optimize=True)
    #buy_ema_rel_21 = DecimalParameter(0.97, 0.999, default=0.975, space='buy', optimize=True)
    buy_rsi_21 = DecimalParameter(10.0, 28.0, default=25.8, space='buy', optimize=True)
    buy_rsi_1h_21 = DecimalParameter(18.0, 40.0, default=19.3, space='buy', optimize=True)
    ...
    sell_rsi_bb_1 = DecimalParameter(60.0, 80.0, default=71.1, space='sell', optimize=True)

    sell_rsi_bb_2 = DecimalParameter(72.0, 90.0, default=82.6, space='sell', optimize=True)

    sell_rsi_main_3 = DecimalParameter(77.0, 90.0, default=87.5, space='sell', optimize=True)

    sell_dual_rsi_rsi_4 = DecimalParameter(72.0, 84.0, default=77.9, space='sell', optimize=True)
    sell_dual_rsi_rsi_1h_4 = DecimalParameter(78.0, 92.0, default=88.5, space='sell', optimize=True)
    ...
    sell_rsi_under_6 = DecimalParameter(72.0, 90.0, default=77.4, space='sell', optimize=True)

    sell_rsi_1h_7 = DecimalParameter(80.0, 95.0, default=84.9, space='sell', optimize=True)

    sell_bb_relative_8 = DecimalParameter(1.05, 1.3, default=1.274, space='sell', optimize=True)

    sell_custom_profit_0 = DecimalParameter(0.01, 0.1, default=0.078, space='sell', optimize=True)
    sell_custom_rsi_0 = DecimalParameter(30.0, 40.0, default=39.394, space='sell', optimize=True)
    sell_custom_profit_1 = DecimalParameter(0.01, 0.1, default=0.019, space='sell', optimize=True)
    sell_custom_rsi_1 = DecimalParameter(30.0, 50.0, default=43.21, space='sell', optimize=True)
    sell_custom_profit_2 = DecimalParameter(0.01, 0.1, default=0.01, space='sell', optimize=True)
    sell_custom_rsi_2 = DecimalParameter(34.0, 50.0, default=35.97, space='sell', optimize=True)
    sell_custom_profit_3 = DecimalParameter(0.06, 0.3, default=0.292, space='sell', optimize=True)
    sell_custom_rsi_3 = DecimalParameter(38.0, 55.0, default=41.34, space='sell', optimize=True)
    sell_custom_profit_4 = DecimalParameter(0.3, 0.6, default=0.364, space='sell', optimize=True)
    sell_custom_rsi_4 = DecimalParameter(40.0, 58.0, default=50.33, space='sell', optimize=True)

    sell_custom_under_profit_1 = DecimalParameter(0.01, 0.1, default=0.016, space='sell', optimize=True)
    sell_custom_under_rsi_1 = DecimalParameter(36.0, 60.0, default=40.2, space='sell', optimize=True)
    sell_custom_under_profit_2 = DecimalParameter(0.01, 0.1, default=0.056, space='sell', optimize=True)
    sell_custom_under_rsi_2 = DecimalParameter(46.0, 66.0, default=61.7, space='sell', optimize=True)
    sell_custom_under_profit_3 = DecimalParameter(0.01, 0.1, default=0.06, space='sell', optimize=True)
    sell_custom_under_rsi_3 = DecimalParameter(50.0, 68.0, default=67.2, space='sell', optimize=True)

    sell_custom_dec_profit_1 = DecimalParameter(0.01, 0.1, default=0.096, space='sell', optimize=True)
    sell_custom_dec_profit_2 = DecimalParameter(0.05, 0.2, default=0.189, space='sell', optimize=True)

    sell_trail_profit_min_1 = DecimalParameter(0.1, 0.25, default=0.227, space='sell', optimize=True)
    sell_trail_profit_max_1 = DecimalParameter(0.3, 0.5, default=0.32, space='sell', optimize=True)
    sell_trail_down_1 = DecimalParameter(0.04, 0.2, default=0.169, space='sell', optimize=True)

    sell_trail_profit_min_2 = DecimalParameter(0.01, 0.1, default=0.053, space='sell', optimize=True)
    sell_trail_profit_max_2 = DecimalParameter(0.08, 0.25, default=0.2, space='sell', optimize=True)
    sell_trail_down_2 = DecimalParameter(0.04, 0.2, default=0.153, space='sell', optimize=True)

    sell_trail_profit_min_3 = DecimalParameter(0.01, 0.1, default=0.051, space='sell', optimize=True)
    sell_trail_profit_max_3 = DecimalParameter(0.08, 0.16, default=0.1, space='sell', optimize=True)
    sell_trail_down_3 = DecimalParameter(0.01, 0.04, default=0.013, space='sell', optimize=True)

    sell_custom_profit_under_rel_1 = DecimalParameter(0.01, 0.04, default=0.0, space='sell', optimize=True)
    sell_custom_profit_under_rsi_diff_1 = DecimalParameter(0.0, 20.0, default=19.0, space='sell', optimize=True)
