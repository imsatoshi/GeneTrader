...
class Trader_4(IStrategy):
    ...
    is_optimize_32 = True
    buy_rsi_fast_32 = IntParameter(20, 70, default=66, space='buy', optimize=is_optimize_32)
    buy_rsi_32 = IntParameter(15, 50, default=17, space='buy', optimize=is_optimize_32)
    buy_sma15_32 = DecimalParameter(0.900, 1, default=0.935, decimals=3, space='buy', optimize=is_optimize_32)
    buy_cti_32 = DecimalParameter(-1, 1, default=0.51, decimals=2, space='buy', optimize=is_optimize_32)
    sell_fastx = IntParameter(50, 100, default=60, space='sell', optimize=True)
    cci_opt = True
    sell_loss_cci = IntParameter(low=0, high=600, default=3, space='sell', optimize=cci_opt)
    sell_loss_cci_profit = DecimalParameter(-0.15, 0, default=-0.01, decimals=2, space='sell', optimize=cci_opt)
