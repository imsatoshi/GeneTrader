...
class BB_RPB_TSL_BI(IStrategy):
    ...
    minimal_roi_opt = DecimalParameter(0.01, 0.30, default=0.205, decimals=3, space='sell', optimize=True)
    minimal_roi = {
        "0": minimal_roi_opt.value,
    }
    ...
    ## Buy params
    buy_rmi = IntParameter(30, 50, default=35, space='buy', optimize=True)
    buy_cci = IntParameter(-135, -90, default=-133, space='buy', optimize=True)
    buy_srsi_fk = IntParameter(30, 50, default=25, space='buy', optimize=True)
    buy_cci_length = IntParameter(25, 45, default=25, space='buy', optimize=True)
    buy_rmi_length = IntParameter(8, 20, default=8, space='buy', optimize=True)
    buy_bb_width = DecimalParameter(0.065, 0.135, default=0.095, decimals=3, space='buy', optimize=True)
    buy_bb_delta = DecimalParameter(0.018, 0.035, default=0.025, decimals=3, space='buy', optimize=True)
    buy_ema_diff = DecimalParameter(0.022, 0.027, default=0.025, decimals=3, space='buy', optimize=True)
    buy_bb_factor = DecimalParameter(0.990, 0.999, default=0.995, decimals=3, space='buy', optimize=True)
    buy_closedelta = DecimalParameter(12.0, 18.0, default=15.0, decimals=1, space='buy', optimize=True)
    buy_ema_diff_local_dip = DecimalParameter(0.022, 0.027, default=0.025, decimals=3, space='buy', optimize=True)
    buy_ema_high_local_dip = DecimalParameter(0.90, 1.2, default=0.942, decimals=3, space='buy', optimize=True)
    buy_closedelta_local_dip = DecimalParameter(12.0, 18.0, default=15.0, decimals=1, space='buy', optimize=True)
    buy_rsi_local_dip = IntParameter(15, 45, default=28, space='buy', optimize=True)
    buy_crsi_local_dip = IntParameter(10, 18, default=10, space='buy', optimize=True)
    buy_rsi_fast = IntParameter(35, 50, default=45, space='buy', optimize=True)
    buy_rsi = IntParameter(15, 35, default=35, space='buy', optimize=True)
    buy_ewo = DecimalParameter(-6.0, 5, default=-5.585, decimals=1, space='buy', optimize=True)
    buy_ema_low = DecimalParameter(0.9, 0.99, default=0.942, decimals=3, space='buy', optimize=True)
    buy_ema_high = DecimalParameter(0.95, 1.2, default=1.08, decimals=2, space='buy', optimize=True)
    buy_rsi_fast_ewo_2 = IntParameter(15, 50, default=45, space='buy', optimize=True)
    buy_rsi_ewo_2 = IntParameter(15, 50, default=35, space='buy', optimize=True)
    buy_ema_low_2 = DecimalParameter(0.90, 1.2, default=0.97, decimals=2, space='buy', optimize=True)
    buy_ema_high_2 = DecimalParameter(0.90, 1.2, default=1.087, decimals=3, space='buy', optimize=True)
    buy_ewo_high_2 = DecimalParameter(2.0, 12.0, default=4.179, decimals=1, space='buy', optimize=True)
    buy_ewo2_cti = DecimalParameter(-0.9, -0.0, default=-0.5, decimals=1, space='buy', optimize=True)
    buy_ewo2_r14 = DecimalParameter(-100, -44, default=-60, decimals=0, space='buy', optimize=True)
    buy_r_deadfish_ema = DecimalParameter(0.90, 1.2, default=1.087, decimals=3, space='buy', optimize=True)
    buy_r_deadfish_bb_width = DecimalParameter(0.03, 0.75, default=0.05, decimals=2, space='buy', optimize=True)
    buy_r_deadfish_bb_factor = DecimalParameter(0.90, 1.2, default=1.0, decimals=1, space='buy', optimize=True)
    buy_r_deadfish_volume_factor = DecimalParameter(1, 2.5, default=1.0, decimals=1, space='buy', optimize=True)
    buy_r_deadfish_cti = DecimalParameter(-0.6, -0.0, default=-0.5, decimals=1, space='buy', optimize=True)
    buy_r_deadfish_r14 = DecimalParameter(-60, -44, default=-60, decimals=0, space='buy', optimize=True)
    buy_clucha_bbdelta_close = DecimalParameter(0.01,0.05, default=0.0220, decimals=4, space='buy', optimize=True)
    buy_clucha_bbdelta_tail = DecimalParameter(0.7, 1.2, default=1.02515, decimals=5, space='buy', optimize=True)
    buy_clucha_close_bblower = DecimalParameter(0.001, 0.05, default=0.03669, decimals=5, space='buy', optimize=True)
    buy_clucha_closedelta_close = DecimalParameter(0.001, 0.05, default=0.04401, decimals=5, space='buy', optimize=True)
    buy_clucha_rocr_1h = DecimalParameter(0.1, 1.0, default=0.47782, decimals=5, space='buy', optimize=True)
    buy_ema_cofi = DecimalParameter(0.94, 1.2, default=0.97, decimals=2, space='buy', optimize=True)
    buy_fastk = IntParameter(0, 40, default=20, space='buy', optimize=True)
    buy_fastd = IntParameter(0, 40, default=20, space='buy', optimize=True)
    buy_adx = IntParameter(0, 30, default=30, space='buy', optimize=True)
    buy_ewo_high = DecimalParameter(2, 12, default=3.553, decimals=3, space='buy', optimize=True)
    buy_cofi_cti = DecimalParameter(-0.9, -0.0, default=-0.5, decimals=1, space='buy', optimize=True)
    buy_cofi_39_r14 = DecimalParameter(-100, -44, default=-60, decimals=0, space='buy', optimize=True)
    buy_nfix_39_cti = DecimalParameter(-0.9, -0.0, default=-0.5, decimals=1, space='buy', optimize=True)
    buy_nfix_39_r14 = DecimalParameter(-100, -44, default=-60, decimals=0, space='buy', optimize=True)
    buy_btc_safe = IntParameter(-300, 50, default=-200, space='buy', optimize=True)
    buy_btc_safe_1d = DecimalParameter(-0.075, -0.025, default=-0.05, decimals=3, space='buy', optimize=True)
    buy_threshold = DecimalParameter(0.003, 0.012, default=0.008, decimals=3, space='buy', optimize=True)
    buy_roc_1h = IntParameter(-25, 200, default=10, space='buy', optimize=True)
    buy_bb_width_1h = DecimalParameter(0.3, 2.0, default=0.3, decimals=1, space='buy', optimize=True)

    ## Slippage params
    max_slip = DecimalParameter(0.33, 0.80, default=0.33, decimals=2, space='buy', optimize=True)

    ## Sell params
    sell_btc_safe = IntParameter(-400, -300, default=-365, space='sell', optimize=True)
    sell_cmf = DecimalParameter(-0.4, 0.0, default=0.0, decimals=1, space='sell', optimize=True)
    sell_ema_close_delta = DecimalParameter(0.022, 0.027, default= 0.024, decimals=3, space='sell', optimize=True)
    sell_ema = DecimalParameter(0.97, 0.99, default=0.987, decimals=3, space='sell', optimize=True)
    sell_rsi_delta = IntParameter(4, 15, default=10, space='sell', optimize=True)
    sell_deadfish_bb_width = DecimalParameter(0.03, 0.75, default=0.05, decimals=2, space='sell', optimize=True)
    sell_deadfish_profit = DecimalParameter(-0.15, -0.05, default=-0.05, decimals=2, space='sell', optimize=True)
    sell_deadfish_bb_factor = DecimalParameter(0.90, 1.20, default=1.0, decimals=1, space='sell', optimize=True)
    sell_deadfish_volume_factor = DecimalParameter(1, 2.5, default=1.0, decimals=1, space='sell', optimize=True)
