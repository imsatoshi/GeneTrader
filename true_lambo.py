...
class true_lambo(IStrategy):
    ...
    buy_ema_cofi = DecimalParameter(0.9, 1.2, default=0.97, decimals=3, space='buy', optimize=True)
    buy_fastk = IntParameter(20, 45, default=20, space='buy', optimize=True)
    buy_fastd = IntParameter(20, 45, default=20, space='buy', optimize=True)
    buy_adx = IntParameter(20, 45, default=30, space='buy', optimize=True)
    buy_ewo_high = DecimalParameter(-12, 12, default=3.553, decimals=3, space='buy', optimize=True)

    buy_clucha_bbdelta_close = DecimalParameter(0.0005, 0.042, default=0.034, decimals=4, space='buy', optimize=True)
    buy_clucha_bbdelta_tail = DecimalParameter(0.7, 1.1, default=0.95, decimals=2, space='buy', optimize=True)
    buy_clucha_closedelta_close = DecimalParameter(0.0005, 0.025, default=0.019, decimals=4, space='buy', optimize=True)
    buy_clucha_rocr_1h = DecimalParameter(0.001, 1.0, default=0.131, decimals=3, space='buy', optimize=True)

    buy_clucha_bbdelta_close_2 = DecimalParameter(0.0005, 0.042, default=0.034, decimals=4, space='buy', optimize=True)
    buy_clucha_bbdelta_tail_2 = DecimalParameter(0.7, 1.1, default=0.95, decimals=2, space='buy', optimize=True)
    buy_clucha_closedelta_close_2 = DecimalParameter(0.0005, 0.025, default=0.019, decimals=4, space='buy', optimize=True)
    buy_clucha_rocr_1h_2 = DecimalParameter(0.001, 1.0, default=0.131, decimals=3, space='buy', optimize=True)

    buy_clucha_bbdelta_close_3 = DecimalParameter(0.0005, 0.042, default=0.034, decimals=4, space='buy', optimize=True)
    buy_clucha_bbdelta_tail_3 = DecimalParameter(0.7, 1.1, default=0.95, decimals=2, space='buy', optimize=True)
    buy_clucha_closedelta_close_3 = DecimalParameter(0.0005, 0.025, default=0.019, decimals=4, space='buy', optimize=True)
    buy_clucha_rocr_1h_3 = DecimalParameter(0.001, 1.0, default=0.131, decimals=3, space='buy', optimize=True)

    buy_clucha_bbdelta_close_4 = DecimalParameter(0.0005, 0.06, default=0.034, decimals=5, space='buy', optimize=True)
    buy_clucha_bbdelta_tail_4 = DecimalParameter(0.35, 1.1, default=0.95, decimals=2, space='buy', optimize=True)
    buy_clucha_closedelta_close_4 = DecimalParameter(0.0005, 0.025, default=0.019, decimals=4, space='buy', optimize=True)
    buy_clucha_rocr_1h_4 = DecimalParameter(0.001, 1.0, default=0.131, decimals=3, space='buy', optimize=True)

    buy_gumbo_ema = DecimalParameter(0.9, 1.2, default=0.97, decimals=2, space='buy', optimize=True)
    buy_gumbo_ewo_low = DecimalParameter(-12.0, 5, default=-5.585, decimals=1, space='buy', optimize=True)
    buy_gumbo_cti = DecimalParameter(-0.9, -0.0, default=-0.5, decimals=1, space='buy', optimize=True)
    buy_gumbo_r14 = DecimalParameter(-100, -44, default=-60, decimals=1, space='buy', optimize=True)

    buy_gumbo_tpct_0 = DecimalParameter(0.0, 0.25, default=0.131, decimals=2, space='buy', optimize=True)
    buy_gumbo_tpct_3 = DecimalParameter(0.0, 0.25, default=0.131, decimals=2, space='buy', optimize=True)
    buy_gumbo_tpct_9 = DecimalParameter(0.0, 0.25, default=0.131, decimals=2, space='buy', optimize=True)

    buy_vwap_width = DecimalParameter(0.05, 10.0, default=0.80, decimals=2, space='buy', optimize=True)
    buy_vwap_closedelta = DecimalParameter(10.0, 30.0, default=15.0, decimals=1, space='buy', optimize=True)
    buy_vwap_cti = DecimalParameter(-0.9, -0.0, default=-0.6, decimals=1, space='buy', optimize=True)

    buy_vwap_width_2 = DecimalParameter(0.05, 10.0, default=0.80, decimals=2, space='buy', optimize=True)
    buy_vwap_closedelta_2 = DecimalParameter(10.0, 30.0, default=15.0, decimals=1, space='buy', optimize=True)
    buy_vwap_cti_2 = DecimalParameter(-0.9, -0.0, default=-0.6, decimals=1, space='buy', optimize=True)

    buy_vwap_width_3 = DecimalParameter(0.05, 10.0, default=0.80, decimals=2, space='buy', optimize=True)
    buy_vwap_closedelta_3 = DecimalParameter(10.0, 30.0, default=15.0, decimals=1, space='buy', optimize=True)
    buy_vwap_cti_3 = DecimalParameter(-0.9, -0.0, default=-0.6, decimals=1, space='buy', optimize=True)

    buy_vwap_width_4 = DecimalParameter(0.05, 10.0, default=0.80, decimals=2, space='buy', optimize=True)
    buy_vwap_closedelta_4 = DecimalParameter(10.0, 30.0, default=15.0, decimals=1, space='buy', optimize=True)
    buy_vwap_cti_4 = DecimalParameter(-0.9, -0.0, default=-0.6, decimals=1, space='buy', optimize=True)

    buy_lambo2_ema = DecimalParameter(0.85, 1.15, default=0.942, decimals=2, space='buy', optimize=True)
    buy_lambo2_rsi4 = IntParameter(15, 45, default=45, space='buy', optimize=True)
    buy_lambo2_rsi14 = IntParameter(15, 45, default=45, space='buy', optimize=True)

    buy_V_bb_width = DecimalParameter(0.01, 0.1, default=0.01, decimals=2, space='buy', optimize=True)
    buy_V_cti = DecimalParameter(-0.95, -0.5, default=-0.6, decimals=2, space='buy', optimize=True)
    buy_V_r14 = DecimalParameter(-100, 0, default=-60, decimals=1, space='buy', optimize=True)
    buy_V_mfi = DecimalParameter(10, 40, default=30, decimals=1, space='buy', optimize=True)

    buy_V_bb_width_2 = DecimalParameter(0.01, 0.1, default=0.01, decimals=2, space='buy', optimize=True)
    buy_V_cti_2 = DecimalParameter(-0.95, -0.5, default=-0.6, decimals=2, space='buy', optimize=True)
    buy_V_r14_2 = DecimalParameter(-100, 0, default=-60, decimals=1, space='buy', optimize=True)
    buy_V_mfi_2 = DecimalParameter(10, 40, default=30, decimals=1, space='buy', optimize=True)

    buy_V_bb_width_4 = DecimalParameter(0.01, 0.1, default=0.01, decimals=2, space='buy', optimize=True)
    buy_V_cti_4 = DecimalParameter(-0.95, -0.0, default=-0.6, decimals=2, space='buy', optimize=True)
    buy_V_r14_4 = DecimalParameter(-100, 0, default=-60, decimals=1, space='buy', optimize=True)
    buy_V_mfi_4 = DecimalParameter(10, 40, default=30, decimals=1, space='buy', optimize=True)

    buy_V_bb_width_5 = DecimalParameter(0.01, 0.1, default=0.01, decimals=2, space='buy', optimize=True)
    buy_V_cti_5 = DecimalParameter(-0.95, -0.0, default=-0.6, decimals=2, space='buy', optimize=True)
    buy_V_r14_5 = DecimalParameter(-100, 0, default=-60, decimals=1, space='buy', optimize=True)
    buy_V_mfi_5 = DecimalParameter(10, 40, default=30, decimals=1, space='buy', optimize=True)
    buy_V_diff_5 = DecimalParameter(0.10, 0.20, default=0.10, decimals=2, space='buy', optimize=True)

    buy_pump_2_factor = DecimalParameter(1.0, 1.20, default= 1.1, decimals=2, space='buy', optimize=True)

    buy_crash_4_tpct_0 = DecimalParameter(0.02, 0.04, default=0.02, decimals=3, space='buy', optimize=True)
    buy_crash_4_tpct_3 = DecimalParameter(0.05, 0.10, default=0.05, decimals=2, space='buy', optimize=True)
    buy_crash_4_tpct_9 = DecimalParameter(0.13, 0.32, default=0.13, decimals=2, space='buy', optimize=True)

    base_nb_candles_sell = IntParameter(5, 80, default=23, space='sell', optimize=False)
    high_offset          = DecimalParameter(0.85, 1.1, default=0.87, decimals=3, space='sell', optimize=True)
    high_offset_2        = DecimalParameter(0.85, 1.5, default=1.166, decimals=3, space='sell', optimize=True)

    ## Trailing params
    # hard stoploss profit
    pHSL = DecimalParameter(-0.10, -0.040, default=-0.08, decimals=3, space='sell', optimize=True)
