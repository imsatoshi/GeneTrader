...
class CoreStrategy(IStrategy):
    ...
    minimal_roi_0 = DecimalParameter(0.01, 0.20, default=0.038, decimals=3, space="buy", optimize=True)
    minimal_roi_38 = DecimalParameter(0.01, 0.20, default=0.074, decimals=3, space="buy", optimize=True)
    minimal_roi_78 = DecimalParameter(0.0, 0.10, default=0.025, decimals=3, space="buy", optimize=True)
    minimal_roi_194 = DecimalParameter(0.0, 0.10, default=0.0, decimals=2, space="buy", optimize=True)
    minimal_roi = {
        "0": minimal_roi_0.value,
        "38": minimal_roi_38.value,
        "78": minimal_roi_78.value,
        "194": minimal_roi_194.value
    }
    # minimal_roi = {"0": minimal_roi_0, "38": minimal_roi_38, "78": minimal_roi_78, "194": minimal_roi_194}
    stoploss_opt = DecimalParameter(-0.5, -0.1, default=-0.228, decimals=3, space="buy", optimize=True)
    ...
    smaoffset_buy_condition_1_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    smaoffset_sell_condition_0_enable = CategoricalParameter([True, False], default=True, space="sell", optimize=True)

    # hyperopt parameters for SMAOffsetProtectOpt
    base_nb_candles_buy = IntParameter(5, 80, default=20, space="buy", optimize=True)
    ...
    high_offset = DecimalParameter(0.99, 1.1, default=1.012, space="sell", optimize=True)
    ...
    ewo_low = DecimalParameter(-20.0, -8.0, default=-19.9, decimals=1, space="buy", optimize=True)
    ewo_high = DecimalParameter(2.0, 12.0, default=5.499, space="buy", optimize=True)
    rsi_buy = IntParameter(30, 70, default=50, space="buy", optimize=True)

    # Buy CombinedBinHClucAndMADV6
    v6_buy_condition_0_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    v6_buy_condition_1_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    v6_buy_condition_2_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    v6_buy_condition_3_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    
    # Buy CombinedBinHClucV8
    v8_buy_condition_0_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    v8_buy_condition_1_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    v8_buy_condition_2_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    v8_buy_condition_3_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    v8_buy_condition_4_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    v8_sell_condition_0_enable = CategoricalParameter([True, False], default=True, space="sell", optimize=True)
    v8_sell_condition_1_enable = CategoricalParameter([True, False], default=True, space="sell", optimize=True)
    
    v8_sell_rsi_main = DecimalParameter(72.0, 90.0, default=80, decimals=2, space="sell", optimize=True)
    buy_dip_threshold_0 = DecimalParameter(0.001, 0.1, default=0.015, decimals=3, space="buy", optimize=True)
    buy_dip_threshold_1 = DecimalParameter(0.08, 0.2, default=0.12, decimals=2, space="buy", optimize=True)
    buy_dip_threshold_2 = DecimalParameter(0.02, 0.4, default=0.28, decimals=2, space="buy", optimize=True)
    buy_dip_threshold_3 = DecimalParameter(0.25, 0.44, default=0.36, decimals=2, space="buy", optimize=True)
    buy_bb40_bbdelta_close = DecimalParameter(0.005, 0.04, default=0.031, decimals=3, space="buy", optimize=True)
    buy_bb40_closedelta_close = DecimalParameter(0.01, 0.03, default=0.021, decimals=3, space="buy", optimize=True)
    buy_bb40_tail_bbdelta = DecimalParameter(0.2, 0.4, default=0.264, decimals=2, space="buy", optimize=True)
    buy_bb20_close_bblowerband = DecimalParameter(0.8, 1.1, default=0.992, decimals=3, space="buy", optimize=True)
    buy_bb20_volume = IntParameter(18, 36, default=29, space="buy", optimize=True)
    buy_rsi_diff = DecimalParameter(34.0, 60.0, default=50.48, decimals=2, space="buy", optimize=True)
    buy_min_inc = DecimalParameter(0.005, 0.05, default=0.01, decimals=2, space="buy", optimize=True)
    buy_rsi_1h = DecimalParameter(40.0, 70.0, default=67.0, decimals=2, space="buy", optimize=True)
    buy_rsi = DecimalParameter(30.0, 40.0, default=38.5, decimals=2, space="buy", optimize=True)
    buy_mfi = DecimalParameter(36.0, 65.0, default=36.0, decimals=2, space="buy", optimize=True)
    buy_volume_1 = DecimalParameter(1.0, 10.0, default=2.0, decimals=2, space="buy", optimize=True)
    buy_ema_open_mult_1 = DecimalParameter(0.01, 0.05, default=0.02, decimals=3, space="buy", optimize=True)
    sell_custom_roi_profit_1 = DecimalParameter(0.01, 0.03, default=0.01, decimals=2, space="sell", optimize=True)
    sell_custom_roi_rsi_1 = DecimalParameter(40.0, 56.0, default=50, decimals=2, space="sell", optimize=True)
    sell_custom_roi_profit_2 = DecimalParameter(0.01, 0.20, default=0.04, decimals=2, space="sell", optimize=True)
    sell_custom_roi_rsi_2 = DecimalParameter(42.0, 56.0, default=50, decimals=2, space="sell", optimize=True)
    sell_custom_roi_profit_3 = DecimalParameter(0.15, 0.30, default=0.08, decimals=2, space="sell", optimize=True)
    sell_custom_roi_rsi_3 = DecimalParameter(44.0, 58.0, default=56, decimals=2, space="sell", optimize=True)
    sell_custom_roi_profit_4 = DecimalParameter(0.3, 0.7, default=0.14, decimals=2, space="sell", optimize=True)
    sell_custom_roi_rsi_4 = DecimalParameter(44.0, 60.0, default=58, decimals=2, space="sell", optimize=False)
    sell_custom_roi_profit_5 = DecimalParameter(0.01, 0.1, default=0.04, decimals=2, space="sell", optimize=True)
    sell_trail_profit_min_1 = DecimalParameter(0.1, 0.25, default=0.1, decimals=3, space="sell", optimize=True)
    sell_trail_profit_max_1 = DecimalParameter(0.3, 0.5, default=0.4, decimals=2, space="sell", optimize=True)
    sell_trail_down_1 = DecimalParameter(0.04, 0.1, default=0.03, decimals=3, space="sell", optimize=True)
    sell_trail_profit_min_2 = DecimalParameter(0.01, 0.1, default=0.02, decimals=3, space="sell", optimize=True)
    sell_trail_profit_max_2 = DecimalParameter(0.08, 0.25, default=0.1, decimals=2, space="sell", optimize=True)
    sell_trail_down_2 = DecimalParameter(0.04, 0.2, default=0.015, decimals=3, space="sell", optimize=True)
    sell_custom_stoploss_1 = DecimalParameter(-0.15, -0.03, default=-0.05, decimals=2, space="sell", optimize=True)
    # Buy  CombinedBinHClucAndMADV9
    v9_buy_condition_0_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    v9_buy_condition_1_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    v9_buy_condition_2_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    v9_buy_condition_3_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    v9_buy_condition_4_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    v9_buy_condition_5_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    v9_buy_condition_6_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    v9_buy_condition_7_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    v9_buy_condition_8_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    v9_buy_condition_9_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    v9_buy_condition_10_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=True)

    # Sell
    v9_sell_condition_0_enable = CategoricalParameter([True, False], default=False, space="sell", optimize=True)
    buy_bb20_close_bblowerband_safe_1 = DecimalParameter(0.7, 1.1, default=0.99, space="buy", optimize=True)
    buy_bb20_close_bblowerband_safe_2 = DecimalParameter(0.7, 1.1, default=0.982, decimals=3, space="buy", optimize=True)
    buy_volume_pump_1 = DecimalParameter(0.1, 0.9, default=0.4, decimals=1, space="buy", optimize=True)
    buy_volume_drop_1 = DecimalParameter(1, 10, default=4, decimals=1, space="buy", optimize=True)
    buy_rsi_1h_1 = DecimalParameter(10.0, 40.0, default=16.5, decimals=1, space="buy", optimize=True)
    buy_rsi_1h_2 = DecimalParameter(10.0, 40.0, default=15.0, decimals=1, space="buy", optimize=True)
    buy_rsi_1h_3 = DecimalParameter(10.0, 40.0, default=20.0, decimals=1, space="buy", optimize=True)
    buy_rsi_1h_4 = DecimalParameter(10.0, 40.0, default=35.0, decimals=1, space="buy", optimize=True)
    buy_rsi_1 = DecimalParameter(10.0, 40.0, default=28.0, decimals=1, space="buy", optimize=True)
    buy_rsi_2 = DecimalParameter(7.0, 40.0, default=10.0, decimals=1, space="buy", optimize=True)
    buy_rsi_3 = DecimalParameter(7.0, 40.0, default=14.2, decimals=1, space="buy", optimize=True)
    buy_macd_1 = DecimalParameter(0.01, 0.09, default=0.02, decimals=2, space="buy", optimize=True)
    buy_macd_2 = DecimalParameter(0.01, 0.09, default=0.03, decimals=2, space="buy", optimize=True)
    # minimum conditions to match in buy
    buy_minimum_conditions = IntParameter(1, 2, default=1, space="buy", optimize=True)
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        # 将条件列初始化为整数类型而不是布尔类型
        dataframe.loc[:, "v9_buy_condition_1_enable"] = 0
        dataframe.loc[:, "v9_buy_condition_2_enable"] = 0
        dataframe.loc[:, "v9_buy_condition_3_enable"] = 0
        dataframe.loc[:, "v9_buy_condition_4_enable"] = 0
        dataframe.loc[:, "v9_buy_condition_5_enable"] = 0
        dataframe.loc[:, "v9_buy_condition_6_enable"] = 0
        dataframe.loc[:, "v9_buy_condition_7_enable"] = 0
        dataframe.loc[:, "v9_buy_condition_8_enable"] = 0
        dataframe.loc[:, "v9_buy_condition_9_enable"] = 0
        dataframe.loc[:, "v9_buy_condition_10_enable"] = 0
        dataframe.loc[:, "v6_buy_condition_0_enable"] = 0
        dataframe.loc[:, "v6_buy_condition_1_enable"] = 0
        dataframe.loc[:, "v6_buy_condition_2_enable"] = 0
        dataframe.loc[:, "v6_buy_condition_3_enable"] = 0
        dataframe.loc[:, "v8_buy_condition_0_enable"] = 0
        dataframe.loc[:, "v8_buy_condition_1_enable"] = 0
        dataframe.loc[:, "v8_buy_condition_2_enable"] = 0
        dataframe.loc[:, "v8_buy_condition_3_enable"] = 0
        dataframe.loc[:, "v8_buy_condition_4_enable"] = 0
        dataframe.loc[:, "smaoffset_buy_condition_0_enable"] = 0
        dataframe.loc[:, "smaoffset_buy_condition_1_enable"] = 0
